...
{
  0xB359000Eul, 0xA0000000ul, 0x794D052Dul, 0x86B2FAD2ul,
...
#else /*BRS_DERIVATIVE_GROUP_TC4xx*/
#define BRS_INTERRUPT_IR_BASE  0xF0030000                       /* Interrupt base Adresse */
#define BRS_INT_SRC_BASE      (BRS_INTERRUPT_IR_BASE + 0x2000)  /* Interrupt base source adresse */

/* Defining some interrupt masks */
#define BRS_INT_SRC_SRE_MASK    0x00800000
#define BRS_INT_SRC_SETR_MASK   0x04000000

#define BRS_INT_SRC(x)          BRSHW_IOS(uint32, BRS_INT_SRC_BASE + x*4) /* Interrupt Router SRC Registers */
#endif
...
# if defined (BRS_DERIVATIVE_GROUP_TC4xx)
   #error "No WDT implementation for TC4xx so far. Disable "EnableWatchdogHandling" in CFG5 vBRS module !"
# else
/*****************************************************************************/
...
# if defined (BRS_DERIVATIVE_GROUP_TC4xx)
   #error "No PLL implementation for TC4xx so far. Disable "EnablePLLClocksHandling" in CFG5 vBRS module !"
# else
/*****************************************************************************/
...
# endif /*BRS_PLL_GROUP_A*/
#endif /*BRS_DERIVATIVE_GROUP_TC4xx*/
