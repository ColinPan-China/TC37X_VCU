 ...
 *        SW-C Type:  CtAp_SpdLmt
 *
 *        Generator:  MICROSAR RTE Generator Version 4.26.0
 *                    RTE Core Version 1.26.0
 *          License:  CBD2101138
 *
 *      Description:  C-Code implementation template for SW-C <CtAp_SpdLmt>
 *********************************************************************************************************************/
...
/**********************************************************************************************************************
 *
 * Runnable Entity Name: R_SpdLmt_Cyclic_10ms
 *
 *---------------------------------------------------------------------------------------------------------------------
 *
 ...
 *   Std_ReturnType Rte_Read_RTE_R_ComM_IVIFwdMaxVehSpdLmtSwt_Enum_tec_ComM_IVIFwdMaxVehSpdLmtSwt_Enum(uint8 *data)
 *   Std_ReturnType Rte_Read_RTE_R_ComM_IVIFwdVehSpdAllwd_Enum_tec_ComM_IVIFwdVehSpdAllwd_Enum(uint8 *data)
 *   Std_ReturnType Rte_Read_RTE_R_ComM_NodComFailr_tec_ComM_IVINodComFailr_Flg(boolean *data)
 *   Std_ReturnType Rte_Read_RTE_R_DiagApp_SpdLmtInfo_tec_DiagApp_SpdLmtInfo(uint8 *data)
 *   Std_ReturnType Rte_Read_RTE_R_DiagApp_SpdLmtUpdateInfo_tec_DiagApp_SpdLmtUpdateInfo(boolean *data)
 ...
 *   Explicit S/R API:
 *   -----------------
 *   Std_ReturnType Rte_Write_RTE_P_TorqPahMgmt_FwdMaxSpdSts_Flg_tec_TorqPahMgmt_FwdMaxSpdSts_Flg(boolean data)
 *   Std_ReturnType Rte_Write_RTE_P_TorqPahMgmt_FwdMaxVehSpd_Enum_tec_TorqPahMgmt_FwdMaxVehSpd_Enum(uint8 data)
 *   Std_ReturnType Rte_Write_RTE_P_TorqPahMgmt_MaxVehSpdLmtTqSts_Flg_tec_TorqPahMgmt_MaxVehSpdLmtTqSts_Flg(boolean data)
 *   Std_ReturnType Rte_Write_RTE_P_TorqPahMgmt_MaxVehSpdLmtTq_Nm_tec_TorqPahMgmt_MaxVehSpdLmtTq_Nm(float32 data)
 *   Std_ReturnType Rte_Write_RTE_P_TorqPahMgmt_SpdLmtReadInfo_tec_TorqPahMgmt_SpdLmtReadInfo(float32 data)
 *
 *********************************************************************************************************************/
/**********************************************************************************************************************
 * DO NOT CHANGE THIS COMMENT!           << Start of documentation area >>                  DO NOT CHANGE THIS COMMENT!
 * Symbol: R_SpdLmt_Cyclic_10ms_doc
 *********************************************************************************************************************/
...
FUNC(void, CtAp_SpdLmt_CODE) R_SpdLmt_Cyclic_10ms(void) /* PRQA S 0624, 3206 */ /* MD_Rte_0624, MD_Rte_3206 */
{
/**********************************************************************************************************************
 * DO NOT CHANGE THIS COMMENT!           << Start of runnable implementation >>             DO NOT CHANGE THIS COMMENT!
 * Symbol: R_SpdLmt_Cyclic_10ms
 *********************************************************************************************************************/
...
/**********************************************************************************************************************
 *
 * Runnable Entity Name: R_SpdLmt_Init
 *
 *---------------------------------------------------------------------------------------------------------------------
 *
...
FUNC(void, CtAp_SpdLmt_CODE) R_SpdLmt_Init(void) /* PRQA S 0624, 3206 */ /* MD_Rte_0624, MD_Rte_3206 */
{
/**********************************************************************************************************************
 * DO NOT CHANGE THIS COMMENT!           << Start of runnable implementation >>             DO NOT CHANGE THIS COMMENT!
 * Symbol: R_SpdLmt_Init
 *********************************************************************************************************************/
