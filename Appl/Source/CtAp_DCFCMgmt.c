 ...
 *  FILE DESCRIPTION
 *  -------------------------------------------------------------------------------------------------------------------
 *             File:  CtAp_DCFCMgmt.c
 *           Config:  TC37X_VCU.dpa
 *        SW-C Type:  CtAp_DCFCMgmt
 *
 *        Generator:  MICROSAR RTE Generator Version 4.26.0
 *                    RTE Core Version 1.26.0
 *          License:  CBD2101138
 *
 *      Description:  C-Code implementation template for SW-C <CtAp_DCFCMgmt>
 *********************************************************************************************************************/
 ...
 * Rte_DT_dt_HvMgmt_DCFCRlyClsDTC_0: Boolean
 * Rte_DT_dt_HvMgmt_DCFCRlyClsDTC_1: Integer in interval [0...255]
 * Rte_DT_dt_HvMgmt_DCFCRlyClsDTC_2: Integer in interval [0...255]
 * Rte_DT_dt_HvMgmt_DCFCRlyClsDTC_3: Boolean
 ...
 * dt_HvMgmt_DCFCRlyClsDTC: Record with elements
 *   HvMgmt_MonStatDCFCRlyClsDTC of type Rte_DT_dt_HvMgmt_DCFCRlyClsDTC_0
 *   HvMgmt_MonResDCFCRlyClsDTC of type Rte_DT_dt_HvMgmt_DCFCRlyClsDTC_1
 *   HvMgmt_ErrStatDCFCRlyClsDTC of type Rte_DT_dt_HvMgmt_DCFCRlyClsDTC_2
 *   HvMgmt_ErrResDCFCRlyClsDTC of type Rte_DT_dt_HvMgmt_DCFCRlyClsDTC_3
 *
 *********************************************************************************************************************/
...
/**********************************************************************************************************************
 *
 * Runnable Entity Name: R_DCFCMgmt_Cyclic_20ms
 *
 *---------------------------------------------------------------------------------------------------------------------
 *
 ...
 *   Explicit S/R API:
 *   -----------------
 *   Std_ReturnType Rte_Write_RTE_P_HvMgmt_DCFCRlyClsDTC_Bus_tec_HvMgmt_DCFCRlyClsDTC_Bus(const dt_HvMgmt_DCFCRlyClsDTC *data)
 *   Std_ReturnType Rte_Write_RTE_P_HvMgmt_DCFCWrkModActSts_Enum_tec_HvMgmt_DCFCWrkModActSts_Enum(uint8 data)
 *
 *********************************************************************************************************************/
/**********************************************************************************************************************
 * DO NOT CHANGE THIS COMMENT!           << Start of documentation area >>                  DO NOT CHANGE THIS COMMENT!
 * Symbol: R_DCFCMgmt_Cyclic_20ms_doc
 *********************************************************************************************************************/
...
FUNC(void, CtAp_DCFCMgmt_CODE) R_DCFCMgmt_Cyclic_20ms(void) /* PRQA S 0624, 3206 */ /* MD_Rte_0624, MD_Rte_3206 */
{
/**********************************************************************************************************************
 * DO NOT CHANGE THIS COMMENT!           << Start of runnable implementation >>             DO NOT CHANGE THIS COMMENT!
 * Symbol: R_DCFCMgmt_Cyclic_20ms
 *********************************************************************************************************************/
...
/**********************************************************************************************************************
 *
 * Runnable Entity Name: R_DCFCMgmt_Init
 *
 *---------------------------------------------------------------------------------------------------------------------
 *
...
FUNC(void, CtAp_DCFCMgmt_CODE) R_DCFCMgmt_Init(void) /* PRQA S 0624, 3206 */ /* MD_Rte_0624, MD_Rte_3206 */
{
/**********************************************************************************************************************
 * DO NOT CHANGE THIS COMMENT!           << Start of runnable implementation >>             DO NOT CHANGE THIS COMMENT!
 * Symbol: R_DCFCMgmt_Init
 *********************************************************************************************************************/
