 ...
 *********************************************************************************************************************/
  ...
  ComM_StateType ComMChannel_ETH = COMM_NO_COM_NO_PENDING_REQUEST;
  ...
  (void)ComM_GetState(ComMConf_ComMChannel_ComMChannel_ETH, &ComMChannel_ETH); /* SBSW_BSWM_FCTCALL_LOCALVAR */
  
  if((CN_TC37X_VCU_CAN00_07b6c9c8 != COMM_NO_COM_NO_PENDING_REQUEST) || (CN_TC37X_VCU_CAN01_70b1f95e != COMM_NO_COM_NO_PENDING_REQUEST) || (CN_LIN00_b12a0454 != COMM_NO_COM_NO_PENDING_REQUEST) || (CN_KAMA_FP_EPT_0303_275b3e6e != COMM_NO_COM_NO_PENDING_REQUEST) || (CN_TC37X_VCU_CAN03_9ebf9872 != COMM_NO_COM_NO_PENDING_REQUEST) || (ComMChannel_ETH != COMM_NO_COM_NO_PENDING_REQUEST))
  {
