 ...
 *********************************************************************************************************************/
  ...
  ComM_StateType CN_J1939_bms_dea99804 = COMM_NO_COM_NO_PENDING_REQUEST;
  ComM_StateType CN_ATOM_HWLIN3_8ac1b423 = COMM_NO_COM_NO_PENDING_REQUEST;
  ComM_StateType CN_ATOM_HWLIN1_64cfd50f = COMM_NO_COM_NO_PENDING_REQUEST;
  ComM_StateType CN_ATOM_HWLIN4_14a52180 = COMM_NO_COM_NO_PENDING_REQUEST;
  ...
  (void)ComM_GetState(ComMConf_ComMChannel_CN_J1939_bms_dea99804, &CN_J1939_bms_dea99804); /* SBSW_BSWM_FCTCALL_LOCALVAR */
  (void)ComM_GetState(ComMConf_ComMChannel_CN_ATOM_HWLIN3_8ac1b423, &CN_ATOM_HWLIN3_8ac1b423); /* SBSW_BSWM_FCTCALL_LOCALVAR */
  (void)ComM_GetState(ComMConf_ComMChannel_CN_ATOM_HWLIN1_64cfd50f, &CN_ATOM_HWLIN1_64cfd50f); /* SBSW_BSWM_FCTCALL_LOCALVAR */
  (void)ComM_GetState(ComMConf_ComMChannel_CN_ATOM_HWLIN4_14a52180, &CN_ATOM_HWLIN4_14a52180); /* SBSW_BSWM_FCTCALL_LOCALVAR */
  
  if((CN_TC37X_VCU_CAN01_70b1f95e != COMM_NO_COM_NO_PENDING_REQUEST) || (CN_ATOM_CANFD_Matrix_CH_V600_202502_a4d436ac != COMM_NO_COM_NO_PENDING_REQUEST) || (CN_ATOM_CAN_Matrix_PT_V600_20250211_9b894f3d != COMM_NO_COM_NO_PENDING_REQUEST) || (CN_ATOM_CAN_XCP_f42a46d4 != COMM_NO_COM_NO_PENDING_REQUEST) || (CN_J1939_bms_dea99804 != COMM_NO_COM_NO_PENDING_REQUEST) || (CN_ATOM_HWLIN3_8ac1b423 != COMM_NO_COM_NO_PENDING_REQUEST) || (CN_ATOM_HWLIN1_64cfd50f != COMM_NO_COM_NO_PENDING_REQUEST) || (CN_ATOM_HWLIN4_14a52180 != COMM_NO_COM_NO_PENDING_REQUEST))
  {
