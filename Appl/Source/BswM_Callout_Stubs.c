 ...
 *********************************************************************************************************************/
  ...
  ComM_StateType CN_TC37X_VCU_CAN12_XCP_d05a85ac = COMM_NO_COM_NO_PENDING_REQUEST;
  ...
  (void)ComM_GetState(ComMConf_ComMChannel_CN_TC37X_VCU_CAN12_XCP_d05a85ac, &CN_TC37X_VCU_CAN12_XCP_d05a85ac); /* SBSW_BSWM_FCTCALL_LOCALVAR */
