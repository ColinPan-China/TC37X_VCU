 ...
 *
 ********************************************************************************/
#ifndef RTW_HEADER_look2_iflf_binncae_h_
#define RTW_HEADER_look2_iflf_binncae_h_
#include "rtwtypes.h"
#define CtAp_FctSftyTorq_START_SEC_CODE
#include "CtAp_FctSftyTorq_MemMap.h"

extern real32_T look2_iflf_binncae(real32_T u0, real32_T u1, const real32_T bp0[],
  const real32_T bp1[], const real32_T table[], const uint32_T maxIndex[],
  uint32_T stride);

#define CtAp_FctSftyTorq_STOP_SEC_CODE
#include "CtAp_FctSftyTorq_MemMap.h"
#endif                                 /* RTW_HEADER_look2_iflf_binncae_h_ */
