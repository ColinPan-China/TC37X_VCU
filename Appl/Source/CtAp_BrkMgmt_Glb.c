...
boolean_T ChassisMgmt_BrkCmpDecelReqActv_Flg;
                  /* Brake compensate deceleration request status: 0:Off 1:On */
boolean_T ChassisMgmt_BrkCmpDecelReqStsOff_Flg;
   /* Brake compensate deceleration request off status: 0:Not active 1:Active */
boolean_T ChassisMgmt_BrkCmpDecelReqStsOn_Flg;
    /* Brake compensate deceleration request on status: 0:Not active 1:Active */
uint8_T ChassisMgmt_BrkCmpSts_Enum; /* Brake compensate on status: 0:Off 1:On */
boolean_T ChassisMgmt_BrkRgnActv_Flg;
                     /* Brake regeneration active status: 0:Inactive 1:Active */
real32_T ChassisMgmt_BrkRgnTq_Nm;      /* Brake regeneration torque */
boolean_T ChassisMgmt_ErrResIBSRbsDesTqOverFltInfo_Flg;/* FUSA FAULT STATUS */
boolean_T ChassisMgmt_IBSRbsDesTqOverFltActv_Flg;
          /* RBS desired torque over limit fault status: 0:Notactive 1:Active */
real32_T ChassisMgmt_RgnTqCapDiffWhlTq_Nm;/* ChassisMgmt RgnTqCapDiffWhlTq Nm */
boolean_T ChassisMgmt_RgnTqCapVldEna2_Flg;
                          /* Brake valid  enable2 status:0:Not active1:Active */
boolean_T ChassisMgmt_RgnTqCapVldEna3_Flg;
                                   /* Brake valid status:0:Not active1:Active */
boolean_T ChassisMgmt_RgnTqCapVldEna4_Flg;
                                   /* Brake valid status:0:Not active1:Active */
boolean_T ChassisMgmt_RgnTqCapVldEna_Flg;
                                  /* Brake valid  status:0:Not active1:Active */
boolean_T ChassisMgmt_RgnTqCapVld_Flg;
                   /* Regeneration torque cap valid status: 0:Invalid 1:Valid */
real32_T ChassisMgmt_RgnTqCap_Nm;      /* Brake regeneration cap torque */
