...
# if (DEM_CFG_HAS_STORAGE_CONDITIONS == STD_ON)
  Dem_MemSet((Dem_DataPtrType)&Dem_Cfg_GetStorageConditionGroupCounter(0),                                                       /* PRQA S 0310, 0312, 0315, 0602 */ /* MD_DEM_11.4_cpy, MD_DEM_11.8, MD_MSR_VStdLibCopy, MD_DEM_20.2 */ /* SBSW_DEM_MEMSET_STORAGECONDITIONGROUPCOUNTER */
    0,
