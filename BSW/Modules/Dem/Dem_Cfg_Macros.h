...
#if (  ((DEM_FEATURE_NEED_OBD == STD_ON) && (DEM_CFG_SUPPORT_PID01 == STD_ON) && (DEM_CFG_SUPPORT_MAJOR_MONITORS == STD_ON) ) \
    || ((DEM_CFG_SUPPORT_OBDONUDS == STD_ON) && (DEM_CFG_SUPPORT_MAJOR_MONITORS == STD_ON)) )
