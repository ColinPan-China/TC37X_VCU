...
#define DEM_CFG_DATA_FROM_IUMPR                                                (50U)  /*!< Data element maps to worst ratio (Numerator and Denominator) of a DTC */
#define DEM_CFG_DATA_FROM_DTR                                                  (51U)  /*!< Data element maps to all DTRs of an event (group) */
#define DEM_CFG_DATA_FROM_MONITOR_ACTIVITY_DATA                                (52U)  /*!< Data element maps to the worst MAN and SMAR of a DTC */
