 ...
 *****************************************************************************/
/*!
 * \brief         Tests whether Calculated Fifo Snapshot Records is enabled.
 *
 * \details       Tests whether Calculated Fifo Snapshot Records is enabled.
 *
 * \return        TRUE
 *                Calculated Fifo is enabled.
 * \return        FALSE
 *                Calculated Fifo is NOT enabled.
 *
 * \pre           -
 *
 * \context       TASK
 ...
 *****************************************************************************/
/*!
 * \brief         Tests whether a snapshot record need to be stored
 *
 * \details       Tests whether a snapshot record pointed to by the iterator
 *                need to be stored
 *
