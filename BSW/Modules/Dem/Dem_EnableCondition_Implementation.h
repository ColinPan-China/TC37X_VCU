  ...
  )
{
  ...
  Dem_MemSet((Dem_DataPtrType)&Dem_Cfg_GetEnableConditionGroupCounter(0),                                                        /* PRQA S 0310, 0312, 0315, 0602 */ /* MD_DEM_11.4_cpy, MD_DEM_11.8, MD_MSR_VStdLibCopy, MD_DEM_20.2 */ /* SBSW_DEM_MEMSET_ENABLECONDITIONGROUPCOUNTER */
    0,
  ...
  Dem_MemSet((Dem_DataPtrType)&Dem_Cfg_GetEnableConditionGroupState(0),                                                          /* PRQA S 0310, 0312, 0315, 0602 */ /* MD_DEM_11.4_cpy, MD_DEM_11.8, MD_MSR_VStdLibCopy, MD_DEM_20.2 */ /* SBSW_DEM_MEMSET_ENABLECONDITIONGROUPSTATE */
    lGroupState,
  ...
  )
{
  ...
  Dem_MemSet((Dem_DataPtrType)&Dem_Cfg_GetEnableConditionGroupCounter(0),                                                        /* PRQA S 0310, 0312, 0315, 0602, 4404 */ /* MD_DEM_11.4_cpy, MD_DEM_11.8, MD_MSR_VStdLibCopy, MD_DEM_20.2, MD_MSR_AutosarBoolean */ /* SBSW_DEM_MEMSET_ENABLECONDITIONGROUPCOUNTER */
    FALSE,
    Dem_Cfg_GetSizeOfEnableConditionGroupCounter()*sizeof(Dem_Cfg_GetEnableConditionGroupCounter(0)));
