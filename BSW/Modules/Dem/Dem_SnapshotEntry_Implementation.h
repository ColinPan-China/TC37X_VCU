...
/* ****************************************************************************
 % Dem_MemoryEntry_SnapshotEntry_IsCalculatedFifoEnabled
 *****************************************************************************/
/*!
 * Internal comment removed.
 *
 ...
 */
DEM_LOCAL_INLINE FUNC(boolean, DEM_CODE)
Dem_MemoryEntry_SnapshotEntry_IsCalculatedFifoEnabled(                                                                           /* PRQA S 3219 */ /* MD_DEM_14.1_CONFIGURATION_SWITCH */
  void
)
{
  return (boolean)(DEM_CFG_SUPPORT_SRECS_CALCULATED_FIFO == STD_ON);
}
...
# endif
  ...
  if (SnapshotEntryIter->MemoryEntryId != DEM_MEMORYENTRY_HANDLE_INVALID)
  {
    ...
    if (Dem_MemoryEntry_SnapshotEntry_IsCalculatedFifoEnabled() == TRUE)
    {
...
# if (DEM_CFG_SUPPORT_SRECS_CALCULATED_FIFO == STD_ON)
  lIndex = SnapshotEntryIter->SnapshotFifoEntryIndex;
# else
  lIndex = 0u;
# endif
  DEM_IGNORE_UNUSED_CONST_ARGUMENT(SnapshotEntryIter)                                                                            /* PRQA S 3112 */ /* MD_DEM_14.2 */
...
#if (DEM_CFG_SUPPORT_SRECS == STD_ON)
/* ****************************************************************************
 % Dem_SnapshotEntry_IteratorNeedToStoreSnapshotRecord
 *****************************************************************************/
/*!
 * Internal comment removed.
 *
 ...
 */
DEM_LOCAL FUNC(boolean, DEM_CODE)
Dem_SnapshotEntry_IteratorNeedToStoreSnapshotRecord(                                                                             /* PRQA S 3219 */ /* MD_DEM_14.1_CONFIGURATION_SWITCH */
  CONSTP2CONST(Dem_Cfg_SnapshotEntry_IterType, AUTOMATIC, AUTOMATIC)  SnapshotEntryIter
)
{
