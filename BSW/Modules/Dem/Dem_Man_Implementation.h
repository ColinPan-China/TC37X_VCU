...
/* ****************************************************************************
 * Dem_Mar_Man_SetManIncrementFlagBitField
 *****************************************************************************/
/*!
...
/* ****************************************************************************
 * Dem_Mar_Man_TestManIncrementedThisDcy
 *****************************************************************************/
/*!
...
/* ****************************************************************************
 * Dem_Mar_Man_SetManIncrementedThisDcy
 *****************************************************************************/
/*!
...
{
#if (DEM_CFG_DATA_MONITOR_ACTIVITY_DATA == STD_ON)                           
  return (Dem_Cfg_MARIndexOfMonitorActivityRatioTableType) DEM_G_NUMBER_OF_MONITOR_ACTIVITY_NUMERATOR_INCREMENTD_ENTRIES;                                                                                 /* PRQA S 2843 */ /* MD_DEM_Dir4.1_ReadOperation */
#else
...
{
#if (DEM_CFG_DATA_MONITOR_ACTIVITY_DATA == STD_ON)
  return (Dem_Cfg_MARIndexOfMonitorActivityRatioTableType)DEM_G_NUMBER_OF_EVENT_WITH_MAR;                                 /* PRQA S 2843 */ /* MD_DEM_Dir4.1_ReadOperation */
#else
  return (Dem_Cfg_MARIndexOfMonitorActivityRatioTableType)0;
#endif
}
...
)
{
  ...
  {
#if (DEM_CFG_DATA_MONITOR_ACTIVITY_DATA == STD_ON)
    Dem_Cfg_ObdIumprData.MonitorActivityNumeratorIncrementedFlag[ManIncrementFlagArrayIdx] = (uint8)ManIncremented;                /* SBSW_DEM_ARRAY_WRITE_MONITORACTIVITYNUMERATORINCREMENTFLAG */
#else
...
)
{
  ...
  lIsManAlreadyIncremented = Dem_Com_TestBitInBitfield(                                                                                                      
      &Dem_Cfg_ObdIumprData.MonitorActivityNumeratorIncrementedFlag[0],                                                          /* SBSW_DEM_POINTER_FORWARD_STACK */
      Dem_Mar_Man_GetSizeOfIncrementedFlagTable(),
...
)
{
  ...
  Dem_Com_SyncSetBitInBitfield(
    &Dem_Cfg_ObdIumprData.MonitorActivityNumeratorIncrementedFlag[0],                                                            /* SBSW_DEM_POINTER_WRITE_ARGUMENT */
    Dem_Mar_Man_GetSizeOfIncrementedFlagTable(),
    (Dem_HandleType)ManIdx
  );
#else
...
/* ****************************************************************************
 % Dem_Mar_Man_IncrementNumeratorIfAllowed
 *****************************************************************************/
/*!
 * Internal comment removed.
 *
...
{
  Dem_Man_Type lMan;
  lMan = Dem_Mar_Man_GetNumerator(ManIdx);

  if ((Dem_Mar_Man_TestManIncrementedThisDcy(ManIdx) == FALSE)
    && (lMan < DEM_MAN_MAX_VALUE))
  {
    Dem_Mar_Man_SetNumerator(ManIdx, lMan + 1u);
    Dem_Mar_Man_SetManIncrementedThisDcy(ManIdx);
  }
}
...
/* ****************************************************************************
 % Dem_Mar_Man_ResetIncrementedFlags
 *****************************************************************************/
/*!
 * Internal comment removed.
 *
...
)
{
  ...
  {
    Dem_Mar_Man_SetManIncrementFlagBitField(lManIncrementedTableIndex, 0);
  }
}
