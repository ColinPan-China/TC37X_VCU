  ...
  )
{
  ...
  if (lReturnValue == E_OK)
  {
    Dem_MemCpy(&DestinationBuffer->Buffer[lWriteIndex], SourceBuffer, Size);                                                     /* PRQA S 0311, 0315, 0602 */ /* MD_DEM_11.8, MD_MSR_VStdLibCopy, MD_DEM_20.2 */ /* SBSW_DEM_WRITE_DESTINATIONBUFFER */
  }
}
