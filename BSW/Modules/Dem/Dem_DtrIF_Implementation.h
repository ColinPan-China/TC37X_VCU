...
)
{
  ...
  lWriteIdx = Dem_Data_GetDestinationBufferWriteIndex(DidCopyInfoBasePtr->DestinationBuffer);                                    /* SBSW_DEM_POINTER_FORWARD_ARGUMENT */
  lDtrCount = 0;

  (void)Dem_Data_IncrementWriteIndexDestinationBuffer(DidCopyInfoBasePtr->DestinationBuffer, 1);                                 /* SBSW_DEM_POINTER_FORWARD_ARGUMENT */
  ...
  Dem_Data_WriteDestinationBufferAtIndex(DidCopyInfoBasePtr->DestinationBuffer, lWriteIdx, lDtrCount);                           /* SBSW_DEM_POINTER_FORWARD_ARGUMENT */
