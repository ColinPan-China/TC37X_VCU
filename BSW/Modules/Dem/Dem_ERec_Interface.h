...
*****************************************************************************/
/*!
* \brief         Test if the extended data record is available for the event in
*                in the current PBS variant.
*
* \details       Test if the extended data record is available for the event in
*                in the current PBS variant.
*
* \param[in]     EventId
...
*
* \param[in]     RecordNumber
*                Number of extended data record.
*
* \return        TRUE
*                The extended data record is available.
* \return        FALSE
*                The extended data record is not available.
*
* \pre           Extended data records are configured.
*
* \config        -
*
* \context       TASK|ISR2
