...
# define CCL_ASR4COMMCFG5_VERSION                (0x1401u)
...
# define COMM_E_MULTIPLE_PNC_ASSIGNED            (Std_ReturnType)(4u) /*!< Multiple PNCs are assigned to the affected user */
# define COMM_E_NO_PNC_ASSIGNED                  (Std_ReturnType)(5u) /*!< No PNC is assigned to the affected user */
 ...
 *  \return      E_OK                          Request is accepted
 *               E_NOT_OK                      Invalid parameter
 *               COMM_E_MULTIPLE_PNC_ASSIGNED  Multiple PNCs are assigned to the user
 *               COMM_E_NO_PNC_ASSIGNED        No PNC is assigned to the affected user
 *  \pre         -
 *  \context     ANY
 *  \reentrant   TRUE
 *  \synchronous TRUE
