...
#if (  (COMM_SW_MAJOR_VERSION != (0x14u)) \
...
#if (  (COMM_BUSSM_MAJOR_VERSION != (0x14u)) \
...
#if (COMM_DCM_INDICATION == STD_ON)
# if (  (COMM_DCM_MAJOR_VERSION != (0x14u)) \
...
#if (  (COMM_ECUMBSWM_MAJOR_VERSION != (0x14u)) \
...
#if (  (COMM_NM_MAJOR_VERSION != (0x14u)) \
...
#if (  (COMM_TYPES_MAJOR_VERSION != (0x14u)) \
...
COMM_LOCAL VAR( ComM_PreInitializedType, COMM_VAR_ZERO_INIT )   ComM_PreInitialized = FALSE;
...
#  if ( COMM_MULTIPARTITION == STD_ON )
      if ( PARTITION_IDX != COMM_MASTER_PARTITION_IDX ) /* COV_COMM_MP_NO_OR_ALL_CHANNELS_ON_MASTER_WITH_ERA_OR_EIRA_SIGNALS */
      {
        ...
        ComM_SetBusPncComModeReqSyncCounter( pncIndex, (uint8)(ComM_GetBusPncComModeReqSyncCounter( pncIndex, COMM_MASTER_PARTITION_IDX ) + 1u), PARTITION_IDX ); /* SBSW_COMM_PNC_CSL02 */ /* SBSW_COMM_CSL02_PARTITION_INDEX_ACCESS */
...
#    endif
  {
    for(pncIndex = 0u; pncIndex < ComM_GetSizeOfPnc(); pncIndex++)
    {
      if( (ComM_GetActivePncComMode(pncIndex, COMM_MASTER_PARTITION_IDX) == COMM_PNC_NO_COMMUNICATION) && (ComM_GetBusPncComModeReq(pncIndex, PARTITION_IDX) == COMM_PNC_NO_COMMUNICATION) )
      {
#    if ( COMM_MULTIPARTITION == STD_ON )
#     if (COMM_EXISTS_CHANNEL_ON_MASTER_PARTITION == STD_ON)
        if ( PARTITION_IDX != COMM_MASTER_PARTITION_IDX ) /* COV_COMM_MP_NO_OR_ALL_CHANNELS_ON_MASTER_WITH_NM_SUPPORT */
#     endif
        {
          SchM_Enter_ComM_COMM_EXCLUSIVE_AREA_6();
          ComM_SetBusPncComModeReq( pncIndex, COMM_PNC_PREPARE_SLEEP, PARTITION_IDX ); /* SBSW_COMM_PNC_CSL02 */ /* SBSW_COMM_CSL03_PARTITION_INDEX_ACCESS */
          /* Increment sync counter for ComM_BusPncComModeReq by 1 (relative to the corresponding Master-Counter) */
          ComM_SetBusPncComModeReqSyncCounter( pncIndex, (uint8)(ComM_GetBusPncComModeReqSyncCounter( pncIndex, COMM_MASTER_PARTITION_IDX ) + 1u), PARTITION_IDX ); /* SBSW_COMM_CHANNEL_CSL02 */ /* SBSW_COMM_CSL03_PARTITION_INDEX_ACCESS */
          SchM_Exit_ComM_COMM_EXCLUSIVE_AREA_6();
        }
#     if (COMM_EXISTS_CHANNEL_ON_MASTER_PARTITION == STD_ON)
        else
...
#  endif
  ...
  for ( partitionIdx = 0u; partitionIdx < ComM_GetSizeOfPartitionIdentifiers(); partitionIdx++ )
  {
    for ( pncIndex = 0u; pncIndex < ComM_GetSizeOfPnc(); pncIndex++ )
    {
      if ( ComM_GetBusPncComModeReqSyncCounter( pncIndex, PARTITION_IDX ) == (uint8)(ComM_GetBusPncComModeReqSyncCounter( pncIndex, COMM_MASTER_PARTITION_IDX ) + 1u) ) /* COV_COMM_MP_NO_OR_ALL_CHANNELS_ON_MASTER_WITH_ERA_OR_EIRA_SIGNALS */
      {
        SchM_Enter_ComM_COMM_EXCLUSIVE_AREA_6();
...
#  endif
        ...
        ComM_SetBusPncComModeReqSyncCounter( pncIndex, (ComM_GetBusPncComModeReqSyncCounter( pncIndex, PARTITION_IDX )), COMM_MASTER_PARTITION_IDX ); /* SBSW_COMM_PNC_CSL02 */ /* SBSW_COMM_CSL03_PARTITION_INDEX_ACCESS */
...
# if ( (COMM_PNC_SUPPORT == STD_ON) && ( (COMM_EXISTS_EIRA_TX_TYPEOFPNCSIGNAL == STD_ON) || (COMM_PNC_TO_CHANNEL_ROUTING_LIMITATION_ENABLED == STD_ON) ) )
  P2CONST( ComM_PncSignalValuesType, AUTOMATIC, COMM_VAR_NOINIT) pncSignalValuesPtr;
# endif
...
#    endif
          {
            ...
            ComM_SetBusPncComModeReq( pncIndex, COMM_PNC_PREPARE_SLEEP, PARTITION_IDX ); /* SBSW_COMM_PNC_CSL02 */ /* SBSW_COMM_CSL03_PARTITION_INDEX_ACCESS */
            /* Increment sync counter for ComM_BusPncComModeReq by 1 (relative to the corresponding Master-Counter) */
            ComM_SetBusPncComModeReqSyncCounter( pncIndex, (uint8)(ComM_GetBusPncComModeReqSyncCounter( pncIndex, COMM_MASTER_PARTITION_IDX ) + 1u), PARTITION_IDX ); /* SBSW_COMM_PNC_CSL02 */ /* SBSW_COMM_CSL03_PARTITION_INDEX_ACCESS */
            SchM_Exit_ComM_COMM_EXCLUSIVE_AREA_6();
          }
#    if (COMM_EXISTS_CHANNEL_ON_MASTER_PARTITION == STD_ON)
          else
...
\DESCRIPTION       In Multi-Partition configurations, the following arrays are accessed with a 'PartitionIndex' (via indirection over
                   ...
                   - Sync-Arrays:     BusComModeReqSyncCounter, BusPncComModeReqSyncCounter, BusSleepModeIndicatedSyncCounter, BusComModeReqFrShutdownSyncCounter,
