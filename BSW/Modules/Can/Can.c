...
#endif
#if( DRVCAN_MPC5700MCANASR_VERSION != 0x0509)
# error "Source and Header file are inconsistent!"
#endif
...
# endif
# if defined (C_ENABLE_CANGLOBALBASEADR) /* COV_CAN_HW_SPECIFIC */
V_DEF_FUNC(CAN_LOCAL_INLINE, void, STATIC_CODE) CanLL_InitGlobalVirtualAddr(void);
# endif
#endif
...
# if defined (C_ENABLE_CANGLOBALBASEADR) /* COV_CAN_HW_SPECIFIC */
/****************************************************************************
| NAME:             CanLL_InitGlobalVirtualAddr
****************************************************************************/
/*
|<DataModelStart>| CanLL_InitGlobalVirtualAddr
Relation_Context:
# CanLL_InitGlobalVirtualAddr() #
Relation:
OneChOpt
ChannelAmount
VirtualAddressing
...
V_DEF_FUNC(CAN_LOCAL_INLINE, void, STATIC_CODE) CanLL_InitGlobalVirtualAddr(void)
{
  ...
  Can_SetCanVirtualGlobalBaseAdr((vuint32)(ApplCanPowerOnGetBaseAddress((vuint32)(Can_GetCanGlobalBaseAdr()), sizeof(vuint32))));
}
# endif
/****************************************************************************
