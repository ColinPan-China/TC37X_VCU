 ...
 *  VERSION CHECK
 *********************************************************************************************************************/
# if ( LINIF_SLAVE_MAJOR_VERSION != (9u) )
...
)
{
  ...
  if ( targetedResetCalloutRetVal != LinIf_J2602TargetedReset_NoResp )
  {
    if ( Nad != LinIf_NAD_Broadcast )
    {
      ...
      {
        SlaveChannelDataPtr->LinIf_NcRespBuffer[2] = 0xF5u;                                     /* RSID, positive response code */ /* SBSW_LINIF_PASSED_PTR_ACCESS */
      }
...
#  endif
    {
      ...
      if ( TriggerResponse == TRUE )
      {
        ...
        slaveChannelDataPtr->LinIf_NcRespBuffer[2] = 0xF5u;                                       /* RSID, positive response code */ /* SBSW_LINIF_MASTER_SLAVE_CHANNEL_DATA_PTR */
