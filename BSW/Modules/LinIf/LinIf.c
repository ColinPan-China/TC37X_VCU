...
#if ( LINIF_SW_MAJOR_VERSION != (9u) ) /* COV_LINIF_CONFIG XF */
...
#if ( LINIF_TPS_MAJOR_VERSION != (9u) ) /* COV_LINIF_CONFIG XF */
...
#if ( LINIF_CBK_MAJOR_VERSION != (9u) ) /* COV_LINIF_CONFIG XF */
...
#if ( LINIF_TP_SUPPORTED == STD_ON )
# if ( LINTP_TPS_MAJOR_VERSION != (9u) ) /* COV_LINIF_CONFIG XF */
