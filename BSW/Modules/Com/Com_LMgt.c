...
# if (COM_DEFERREDGWMAPPINGINFOUSEDOFRXPDUINFO == STD_ON)       /* COV_COM_VAR_ELISA_STD_OFF_XF */
  ...
  if(Com_IsDeferredGwMappingInfoUsedOfRxPduInfo(rxPduId))
  {
    Com_SetDeferredGwMappingEvent(Com_GetDeferredGwMappingInfoIdxOfRxPduInfo(rxPduId), 0);      /* SBSW_COM_CSL02_CSL03 */
  }
# endif
