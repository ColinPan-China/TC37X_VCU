 ...
 *                on activation. All I-PDUs, that have not changed their deadline monitoring state, are not processed.
    \details      -
    \pre          -
    \param[in]    rxPduId -  ID of the RX-PDU
    \param[in]    bRequestedActiveState - true if at least one of the IPDU-Groups of rxPduId is active
...
/*! \brief        This function evaluates requested active state of the I-PDU
    \details      -
    \pre          -
    \param[in]    rxPduId          ID of the I-PDU
    ...
    \reentrant    FALSE
**********************************************************************************************************************/
FUNC(Com_RxPduDmStateType, COM_CODE) Com_ReceptionDMControl_EvaluateActiveState(Com_IpduGroupVector ipduGroupVector, Com_RxPduInfoIterType rxPduId);
# endif
