...
FUNC(void, COM_CODE) Com_TxDlMon_MainFunctionTx(Com_MainFunctionTxStructIterType mainFunctionId)
{
  ...
  if(Com_IsTxTOutInfoOfMainFunctionTxIndUsedOfMainFunctionTxStruct(mainFunctionId))     /* COV_COM_SILENT_TX */
  {
...
FUNC(void, COM_CODE) Com_GwTout_HandleCounter(Com_MainFunctionTxStructIterType mainFunctionId)
{
  ...
  if(Com_IsGwTimeoutInfoOfMainFunctionTxIndUsedOfMainFunctionTxStruct(mainFunctionId))  /* COV_COM_SILENT_TX */
  {
    Com_GwTimeoutInfoOfMainFunctionTxIndIterType gwTimeoutInfoIndIdx = Com_GetGwTimeoutInfoOfMainFunctionTxIndStartIdxOfMainFunctionTxStruct(mainFunctionId);
...
{
  if(Com_IsRxTOutInfoOfMainFunctionRxIndUsedOfMainFunctionRxStruct(mainFunctionId))     /* COV_COM_SILENT_TX */
  {
    Com_RxTOutInfoOfMainFunctionRxIndIterType rxTOutInfoIndIdx = Com_GetRxTOutInfoOfMainFunctionRxIndStartIdxOfMainFunctionRxStruct(mainFunctionId);
