  ...
  Eth_30_Tc3xx_RegWidthType  regValue)
{
   ...
   *     necessary */
#  if (ETH_30_TC3XX_USE_PERIPHERAL_ACCESS_API == STD_ON) /* COV_ETH_PERIPHERAL_ACCESS */
  osWritePeripheral32((Os_PeripheralIdType)Eth_30_Tc3xx_GetProtectedAreaIdOfEthCtrl(ctrlIdx),
...
#  if (ETH_30_TC3XX_USE_PERIPHERAL_ACCESS_API == STD_ON) /* COV_ETH_PERIPHERAL_ACCESS */
  return osReadPeripheral32((Os_PeripheralIdType)Eth_30_Tc3xx_GetProtectedAreaIdOfEthCtrl(ctrlIdx),
  ...
  Eth_30_Tc3xx_RegWidthType  bitMask)
{
   ...
   *     if necessary */
#  if (ETH_30_TC3XX_USE_PERIPHERAL_ACCESS_API == STD_ON) /* COV_ETH_PERIPHERAL_ACCESS */
  osModifyPeripheral32((Os_PeripheralIdType)Eth_30_Tc3xx_GetProtectedAreaIdOfEthCtrl(ctrlIdx),
...
#  if (ETH_30_TC3XX_USE_PERIPHERAL_ACCESS_API == STD_ON) /* COV_ETH_PERIPHERAL_ACCESS */
  boolean               result = FALSE;
  Eth_30_Tc3xx_RegWidthType reg = osReadPeripheral32((Os_PeripheralIdType)Eth_30_Tc3xx_GetProtectedAreaIdOfEthCtrl(ctrlIdx),
                                                     (uint32)(Eth_30_Tc3xx_GetRegBaseAddress(ctrlIdx) + regOffset));
