...
# define ETH_30_TC3XX_SW_MINOR_VERSION                                (4u)
  ...
  uint8 ctrlIdx)
{
  ...
  /* #10 Iterate over used queues - TX/RX descriptor number is always equal to each other*/
       ...
       queueIdx < Eth_30_Tc3xx_GetTxDescrHandlingEndIdxOfEthCtrl(ctrlIdx); queueIdx++)
  {
    ...
    /* #20 Get TX/RX descriptor counts and addresses */
    uint16 rxDescCount = Eth_30_Tc3xx_GetRxDescrEndIdxOfRxDescrHandling(queueIdx) -
                         Eth_30_Tc3xx_GetRxDescrStartIdxOfRxDescrHandling(queueIdx);
    uint16 txDescCount = Eth_30_Tc3xx_GetTxDescrEndIdxOfTxDescrHandling(queueIdx) -
                         Eth_30_Tc3xx_GetTxDescrStartIdxOfTxDescrHandling(queueIdx);

    /* PRQA S 0306 6 */ /* MD_Eth_30_Tc3xx_0306 */
    ...
    uint32 rxDescLastAddr = (uint32) Eth_30_Tc3xx_GetAddrRxDescr(
                                     Eth_30_Tc3xx_GetRxDescrEndIdxOfRxDescrHandling(queueIdx));
    ...
    /* #30 Announce ring length to hardware */
    ...
    /* #40 Announce descriptor ring to the hardware */
    ...
    /* #50 RX Tail Pointer points to the last descriptor */
    Eth_30_Tc3xx_Reg_Write(ctrlIdx, regOffsetRxDescTailAddr, rxDescLastAddr);

    /* #60 TX Tail Pointer points to the first descriptor */
  ...
  Eth_30_Tc3xx_TxDescrIterType         descrIdx)
{
  ...
  if (descrIdx < (Eth_30_Tc3xx_GetTxDescrEndIdxOfTxDescrHandling(descrRingIdx) - 1u))
  {
    descrIdx++;
  }
  else
  {
    descrIdx = Eth_30_Tc3xx_GetTxDescrStartIdxOfTxDescrHandling(descrRingIdx);
  }
