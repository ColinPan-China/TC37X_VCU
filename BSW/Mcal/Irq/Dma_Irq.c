...
#endif
{
  /* Enable Global Interrupts */
  ENABLE();
//  Spi_QspiDmaCallout(0, DMA_EVENT_CH_TRANSFER_COMPLETE);
...
#endif
{
  /* Enable Global Interrupts */
  ENABLE();
  Spi_QspiDmaCallout(4, DMA_EVENT_CH_TRANSFER_COMPLETE);
...
#endif
{
  /* Enable Global Interrupts */
  ENABLE();
  Spi_QspiDmaCallout(6, DMA_EVENT_CH_TRANSFER_COMPLETE);
...
#endif
{
  /* Enable Global Interrupts */
  ENABLE();
  Spi_QspiDmaCallout(8, DMA_EVENT_CH_TRANSFER_COMPLETE);
...
#endif
{
  /* Enable Global Interrupts */
  ENABLE();
  Spi_QspiDmaCallout(10, DMA_EVENT_CH_TRANSFER_COMPLETE);
