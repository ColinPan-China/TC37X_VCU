...
/* Stack: Core0_BswTask (1024 Byte) */
group OS_STACK_CORE0_BSWTASK_VAR_NOINIT_GROUP(ordered, contiguous, fill, align=8)
{
  select "[.]bss.OS_STACK_CORE0_BSWTASK_VAR_NOINIT";
}
"_OS_STACK_CORE0_BSWTASK_VAR_NOINIT_START" = "_lc_gb_OS_STACK_CORE0_BSWTASK_VAR_NOINIT_GROUP";
"_OS_STACK_CORE0_BSWTASK_VAR_NOINIT_END" = "_lc_ge_OS_STACK_CORE0_BSWTASK_VAR_NOINIT_GROUP" - 1;
"_OS_STACK_CORE0_BSWTASK_VAR_NOINIT_LIMIT" = "_lc_ge_OS_STACK_CORE0_BSWTASK_VAR_NOINIT_GROUP";
