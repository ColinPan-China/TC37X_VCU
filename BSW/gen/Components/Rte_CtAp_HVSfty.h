...
#  define Rte_Read_CtAp_HVSfty_RTE_R_IOAbs_HVILPwmFrq_Hz_tec_IOAbs_HVILPwmFrq_Hz(data) (*(data) = Rte_IoHwAb_SWC_IF_IOAbs_HVILPwmFrq_Hz_tec_IOAbs_HVILPwmFrq_Hz, ((Std_ReturnType)RTE_E_OK))
