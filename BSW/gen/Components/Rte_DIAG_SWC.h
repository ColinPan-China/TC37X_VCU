...
#  define Rte_Call_NvMService_AC3_SRBS_NvBlockNeed_AttemptCounter_ReadBlock(arg1) (NvM_ReadBlock((NvM_BlockIdType)6, arg1))
#  define Rte_Call_NvMService_AC3_SRBS_NvBlockNeed_AttemptCounter_SetRamBlockStatus(arg1) (NvM_SetRamBlockStatus((NvM_BlockIdType)6, arg1))
#  define Rte_Call_NvMService_AC3_SRBS_NvBlockNeed_AttemptCounter_WriteBlock(arg1) (NvM_WriteBlock((NvM_BlockIdType)6, arg1))
...
#  define Rte_Call_PS_DIAG_SWC_NvBlockNeed_DID_F193_ReadBlock(arg1) (NvM_ReadBlock((NvM_BlockIdType)7, arg1))
#  define Rte_Call_PS_DIAG_SWC_NvBlockNeed_DID_F193_SetRamBlockStatus(arg1) (NvM_SetRamBlockStatus((NvM_BlockIdType)7, arg1))
#  define Rte_Call_PS_DIAG_SWC_NvBlockNeed_DID_F193_WriteBlock(arg1) (NvM_WriteBlock((NvM_BlockIdType)7, arg1))
#  define Rte_Call_PS_DIAG_SWC_NvBlockNeed_DiagDID_00_GetErrorStatus(arg1) (NvM_GetErrorStatus((NvM_BlockIdType)5, arg1))
#  define Rte_Call_PS_DIAG_SWC_NvBlockNeed_DiagDID_00_ReadBlock(arg1) (NvM_ReadBlock((NvM_BlockIdType)5, arg1))
#  define Rte_Call_PS_DIAG_SWC_NvBlockNeed_DiagDID_00_SetRamBlockStatus(arg1) (NvM_SetRamBlockStatus((NvM_BlockIdType)5, arg1))
#  define Rte_Call_PS_DIAG_SWC_NvBlockNeed_DiagDID_00_WriteBlock(arg1) (NvM_WriteBlock((NvM_BlockIdType)5, arg1))
