...
#  define Rte_Read_CtAp_ChrgComM_RTE_R_IOAbs_CC2SigUDc_mV_tec_IOAbs_CC2SigUDc_mV(data) (*(data) = Rte_IoHwAb_SWC_IF_IOAbs_CC2SigUDc_mV_tec_IOAbs_CC2SigUDc_mV, ((Std_ReturnType)RTE_E_OK))
