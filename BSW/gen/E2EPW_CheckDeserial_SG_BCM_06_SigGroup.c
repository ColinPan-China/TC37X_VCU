 ...
 ** Module: E2EPW_CheckDeserial_SG_BCM_06_SigGroup.c
...
/******************************************************************
 * Function name      : E2EPW_CheckDeserial_SG_BCM_06_SigGroup
 ...
 * Remarks            : none
 ******************************************************************/
FUNC (uint8, E2EPW_CODE) E2EPW_CheckDeserial_SG_BCM_06_SigGroup
    ( P2CONST (SG_BCM_06_SigGroup, AUTOMATIC, E2EPW_APPL_DATA) pde )
{
    VAR (uint8, AUTOMATIC) ret = 0;

    if ((pde->BCM_PepsPowerMode & 0xf8u) != 0)
    {
        ret = E2EPW_DESERIAL_ERR;
    }

    if ((pde->MessageCounter_271 & 0xf0u) != 0)
    {
        ret = E2EPW_DESERIAL_ERR;
    }

    if ((pde->BCM_PowerOffDisplayReq & 0xfeu) != 0)
    {
        ret = E2EPW_DESERIAL_ERR;
    }
