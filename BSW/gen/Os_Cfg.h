...
# define Rte_Ev_Run_Com_SWC_Com_Runnable_500ms     ((EventMaskType)2uLL)
# define Rte_Ev_Run_Com_SWC_Rte_Msg10Eh_Rx_Notification     ((EventMaskType)4uLL)
# define Rte_Ev_Run_Com_SWC_Rte_Msg10Fh_Rx_Notification     ((EventMaskType)8uLL)
# define Rte_Ev_Run_Com_SWC_Rte_Msg110h_Rx_Notification     ((EventMaskType)16uLL)
# define Rte_Ev_Run_IoHwAb_IoHwAb_IoHwAbRunnable_10ms     ((EventMaskType)8uLL)
...
# define Rte_Ev_Run_SWC1_SWC1_Runnable10ms     ((EventMaskType)256uLL)
