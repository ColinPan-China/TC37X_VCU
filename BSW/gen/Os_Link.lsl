...
if (exists(".bss.OS_CORESHARED_0X00000005_VAR_NOCACHE_NOINIT"))
{
  ...
  "_OS_CORESHARED_0X00000005_VAR_NOCACHE_NOINIT_END" = "_lc_ub__pad_OS_CORESHARED_0X00000005_VAR_NOCACHE_NOINIT" - 1;
  "_OS_CORESHARED_0X00000005_VAR_NOCACHE_NOINIT_LIMIT" = "_lc_ub__pad_OS_CORESHARED_0X00000005_VAR_NOCACHE_NOINIT";
}
else
{
  "_OS_CORESHARED_0X00000005_VAR_NOCACHE_NOINIT_START" = 0;
  "_OS_CORESHARED_0X00000005_VAR_NOCACHE_NOINIT_END" = 0;
  "_OS_CORESHARED_0X00000005_VAR_NOCACHE_NOINIT_LIMIT" = 0;
}
#endif
...
if (exists(".bss.OS_CORESHARED_0X00000005_VAR_FAST_NOCACHE_NOINIT"))
{
  ...
  "_OS_CORESHARED_0X00000005_VAR_FAST_NOCACHE_NOINIT_END" = "_lc_ub__pad_OS_CORESHARED_0X00000005_VAR_FAST_NOCACHE_NOINIT" - 1;
  "_OS_CORESHARED_0X00000005_VAR_FAST_NOCACHE_NOINIT_LIMIT" = "_lc_ub__pad_OS_CORESHARED_0X00000005_VAR_FAST_NOCACHE_NOINIT";
}
else
{
  "_OS_CORESHARED_0X00000005_VAR_FAST_NOCACHE_NOINIT_START" = 0;
  "_OS_CORESHARED_0X00000005_VAR_FAST_NOCACHE_NOINIT_END" = 0;
  "_OS_CORESHARED_0X00000005_VAR_FAST_NOCACHE_NOINIT_LIMIT" = 0;
}
#endif
