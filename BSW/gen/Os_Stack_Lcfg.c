...
/* User: [Core0_BswTask] */
OS_STACK_DECLARE(OsCfg_Stack_Core0_BswTask_Dyn, OS_CFG_SIZE_CORE0_BSWTASK_STACK);
...
/* User: [ADC0SR0_ISR, ADC11SR0_ISR, ADC1SR0_ISR, ADC2SR0_ISR, ADC3SR0_ISR, ADC8SR0_ISR, ASCLIN1ERR_ISR, ASCLIN1RX_ISR, ASCLIN1TX_ISR, ASCLIN2ERR_ISR, ASCLIN2RX_ISR, ASCLIN2TX_ISR, CanIsr_0, CanIsr_1, CanIsr_3, CanIsr_4, CounterIsr_SystemTimer0, DMACH10SR_ISR, DMACH11SR_ISR, EthIsr_EthCtrlConfig_ETHSR2_ISR, EthIsr_EthCtrlConfig_ETHSR6_ISR, GTMTOM1SR3_ISR, GTMTOM1SR4_ISR, QSPI3ERR_ISR, QSPI3PT_ISR, XSignalIsr_OsCore0] */
...
CONST(Os_StackConfigType, OS_CONST) OsCfg_Stack_Core0_BswTask =
{
  /* .LowAddress  = */ OS_STACK_GETLOWADDRESS(OsCfg_Stack_Core0_BswTask_Dyn),
  /* .HighAddress = */ OS_STACK_GETHIGHADDRESS(OsCfg_Stack_Core0_BswTask_Dyn)
};
