...
#endif
#ifndef ETHSM_PROCESSOR_TC377T
#define ETHSM_PROCESSOR_TC377T
#endif
...
#define ETHSM_IS_TCPIP_ENABLED             STD_OFF
#define ETHSM_IS_VECTOR_TCPIP              STD_OFF
...
/** 
  ...
  \{
*/ 
#define ETHSM_EQ2_COMMNETWORKHANDLEOFCHANNELCONFIG                    ComMConf_ComMChannel_ComMChannel_ETH
#define ETHSM_EQ2_CONFIRMATIONTIMEOUTOFCHANNELCONFIG                  5u
#define ETHSM_EQ2_ETHIFCONTROLLEROFCHANNELCONFIG                      ((EthSM_EthIfControllerOfChannelConfigType)EthIfConf_EthIfController_EthIfController)
#define ETHSM_EQ2_MAXRETRIESOFCHANNELCONFIG                           0u
#define ETHSM_EQ2_STACKTYPEOFCHANNELCONFIG                            ETHSM_STACK_TYPE_AVB
...
#define EthSM_GetSizeOfNetIdxByComMNetwHndOfPCConfig()                6u  /**< the number of accomplishable value elements in EthSM_NetIdxByComMNetwHnd */
...
#define EthSM_GetNetIdxByComMNetwHnd(Index)                           (EthSM_GetNetIdxByComMNetwHndOfPCConfig()[(Index)])
...
/** 
  ...
  \{
*/ 
#define EthSM_GetComMNetworkHandleOfChannelConfig(Index)              ComMConf_ComMChannel_ComMChannel_ETH
#define EthSM_GetConfirmationTimeoutOfChannelConfig(Index)            5u
#define EthSM_GetEthIfControllerOfChannelConfig(Index)                ((EthSM_EthIfControllerOfChannelConfigType)EthIfConf_EthIfController_EthIfController)
#define EthSM_GetMaxRetriesOfChannelConfig(Index)                     0u
#define EthSM_GetStackTypeOfChannelConfig(Index)                      ETHSM_STACK_TYPE_AVB
...
/*lint -restore */
extern CONST(EthSM_NetIdxByComMNetwHndType, ETHSM_CONST) EthSM_NetIdxByComMNetwHnd[6];
