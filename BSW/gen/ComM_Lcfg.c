...
/*lint -restore */
CONST(ComM_ChannelType, COMM_CONST) ComM_Channel[6] = {  /* PRQA S 1514, 1533 */  /* MD_CSL_ObjectOnlyAccessedOnce */
  ...
  { /*     4 */ COMM_BUS_TYPE_LIN,     FALSE,         FALSE,           250u,            100u, COMM_LIGHT_NMTYPEOFCHANNEL, COMM_FULL_COM_NETWORK_REQUESTED, LinSM_GetCurrentComMode, LinSM_RequestComMode },  /* [ComMChannel_4] */
  { /*     5 */ COMM_BUS_TYPE_ETH,     FALSE,         FALSE,           250u,            100u, COMM_LIGHT_NMTYPEOFCHANNEL, COMM_FULL_COM_NETWORK_REQUESTED, EthSM_GetCurrentComMode, EthSM_RequestComMode }   /* [ComMChannel_5] */
};
...
#include "ComM_vMemMap.h"  /* PRQA S 5087 */  /* MD_MSR_MemMap */
/*lint -restore */
CONST(ComM_ChannelPbType, COMM_CONST) ComM_ChannelPb[6] = {  /* PRQA S 1514, 1533 */  /* MD_CSL_ObjectOnlyAccessedOnce */
...
#include "ComM_vMemMap.h"  /* PRQA S 5087 */  /* MD_MSR_MemMap */
/*lint -restore */
CONST(ComM_UserType, COMM_CONST) ComM_User[9] = {  /* PRQA S 1514, 1533 */  /* MD_CSL_ObjectOnlyAccessedOnce */
  ...
  { /*     3 */   FALSE,                 4u,                   3u, COMM_NO_USERPNCBYTEMASKENDIDXOFUSER,                    0u, COMM_NO_USERPNCBYTEMASKSTARTIDXOFUSER },  /* [CN_TC37X_VCU_CAN03_5a834971] */
  { /*     4 */   FALSE,                 5u,                   4u, COMM_NO_USERPNCBYTEMASKENDIDXOFUSER,                    0u, COMM_NO_USERPNCBYTEMASKSTARTIDXOFUSER },  /* [CN_LIN00_984dfd9e] */
  { /*     5 */    TRUE,                 6u,                   5u,                                  1u,                    1u,                                    0u },  /* [ComMUser_PNC24] */
  { /*     6 */    TRUE,                 7u,                   6u,                                  2u,                    1u,                                    1u },  /* [ComMUser_PNC26] */
  { /*     7 */    TRUE,                 8u,                   7u,                                  3u,                    1u,                                    2u },  /* [ComMUser_PNC31] */
  { /*     8 */   FALSE,                 9u,                   8u, COMM_NO_USERPNCBYTEMASKENDIDXOFUSER,                    0u, COMM_NO_USERPNCBYTEMASKSTARTIDXOFUSER }   /* [ComMUser_ETH] */
};
#define COMM_STOP_SEC_CONST_UNSPECIFIED
/*lint -save -esym(961, 19.1) */
#include "ComM_vMemMap.h"  /* PRQA S 5087 */  /* MD_MSR_MemMap */
...
#include "ComM_vMemMap.h"  /* PRQA S 5087 */  /* MD_MSR_MemMap */
/*lint -restore */
CONST(ComM_UserByteMaskType, COMM_CONST) ComM_UserByteMask[9] = {  /* PRQA S 1514, 1533 */  /* MD_CSL_ObjectOnlyAccessedOnce */
  ...
  { /*     8 */      5u,     0xFEu,   0x01u,                5u }   /* [/ActiveEcuC/ComM/ComMConfigSet/ComMUser_ETH] */
};
#define COMM_STOP_SEC_CONST_UNSPECIFIED
/*lint -save -esym(961, 19.1) */
#include "ComM_vMemMap.h"  /* PRQA S 5087 */  /* MD_MSR_MemMap */
...
#include "ComM_vMemMap.h"  /* PRQA S 5087 */  /* MD_MSR_MemMap */
/*lint -restore */
VAR(ComM_UserReqFullComType, COMM_VAR_NOINIT) ComM_UserReqFullCom[6];  /* PRQA S 1514, 1533 */  /* MD_CSL_ObjectOnlyAccessedOnce */
  /* Index        Referable Keys */
  ...
  /*     5 */  /* [ComMChannel_5, Channel5_To_User8] */
...
VAR(ComM_UserReqPncFullComType, COMM_VAR_NOINIT) ComM_UserReqPncFullCom[3];  /* PRQA S 1514, 1533 */  /* MD_CSL_ObjectOnlyAccessedOnce */
  /* Index        Referable Keys */
  /*     0 */  /* [/ActiveEcuC/ComM/ComMConfigSet/ComMPnc_24, Pnc24_To_User5] */
  /*     1 */  /* [/ActiveEcuC/ComM/ComMConfigSet/ComMPnc_26, Pnc26_To_User6] */
  /*     2 */  /* [/ActiveEcuC/ComM/ComMConfigSet/ComMPnc_31, Pnc31_To_User7] */
