  ...
  OsCfg_Hal_System_InterruptSourceRefs[OS_CFG_NUM_SYSTEM_INTERRUPTSOURCEREFS + 1u] =
{
  ...
  &OsCfg_Isr_ASCLIN3ERR_ISR_HwConfig,
  &OsCfg_Isr_ASCLIN3RX_ISR_HwConfig,
  &OsCfg_Isr_ASCLIN3TX_ISR_HwConfig,
  &OsCfg_Isr_ASCLIN4ERR_ISR_HwConfig,
  &OsCfg_Isr_ASCLIN4RX_ISR_HwConfig,
  &OsCfg_Isr_ASCLIN4TX_ISR_HwConfig,
  &OsCfg_Isr_CanIsr_0_HwConfig,
  &OsCfg_Isr_CanIsr_1_HwConfig,
  &OsCfg_Isr_CanIsr_2_HwConfig,
  &OsCfg_Isr_CanIsr_3_HwConfig,
  &OsCfg_Isr_CanIsr_4_HwConfig,
  &OsCfg_Isr_CanIsr_6_HwConfig,
  &OsCfg_Isr_CounterIsr_SystemTimer_HwConfig,
  &OsCfg_Isr_DMACH10SR_ISR_HwConfig,
  &OsCfg_Isr_DMACH11SR_ISR_HwConfig,
  &OsCfg_Isr_GTMTOM1SR0_ISR_HwConfig,
  &OsCfg_Isr_GTMTOM1SR1_ISR_HwConfig,
