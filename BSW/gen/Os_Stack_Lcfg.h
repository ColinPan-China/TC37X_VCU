...
/* User: [Bsw_Task] */
extern OS_STACK_DECLARE(OsCfg_Stack_OsCore0_Task_Prio65_Dyn, OS_CFG_SIZE_OSCORE0_TASK_PRIO65_STACK);
...
extern CONST(Os_StackConfigType, OS_CONST) OsCfg_Stack_OsCore0_Task_Prio65;
