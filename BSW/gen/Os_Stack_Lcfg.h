...
/* User: [Core2_Asw_Task] */
extern OS_STACK_DECLARE(OsCfg_Stack_Core2_Asw_Task_Dyn, OS_CFG_SIZE_CORE2_ASW_TASK_STACK);
...
extern CONST(Os_StackConfigType, OS_CONST) OsCfg_Stack_Core2_Asw_Task;
