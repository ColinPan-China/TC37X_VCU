 ...
 ** Module: E2EPW_CtAp_CANHandler_SG_PRND_SigGroup_SG_PRND_SigGroup_rx.c
...
#include "E2EPW_CheckDeserial_SG_PRND_SigGroup.h"
#include "E2EPW_CtAp_CANHandler_SG_PRND_SigGroup_SG_PRND_SigGroup_rx.h"
#ifndef STATIC
...
STATIC VAR (E2E_P01CheckStateType, CtAp_CANHandler_VAR_INIT)
    StateVal_SG_PRND_SigGroup_SG_PRND_SigGroup =
{
      0                        /* LastValidCounter */
    , 0                        /* MaxDeltaCounter  */
...
STATIC P2VAR ( E2E_P01CheckStateType
    ...
    State_SG_PRND_SigGroup_SG_PRND_SigGroup =
        &StateVal_SG_PRND_SigGroup_SG_PRND_SigGroup;
...
STATIC VAR (uint8, CtAp_CANHandler_VAR_NOINIT)
    ppa_SG_PRND_SigGroup_SG_PRND_SigGroup_au8 [8];
...
STATIC CONST (E2E_P01ConfigType, CtAp_CANHandler_CONST)
    ConfigVal_SG_PRND_SigGroup_SG_PRND_SigGroup =
{
      8
    , 0
    , 584
...
/**********************************************************
 * Function name: E2EPW_Init_SG_PRND_SigGroup_SG_PRND_SigGroup_rx ()
 ...
 **********************************************************/
FUNC (void, CtAp_CANHandler_CODE) E2EPW_ReadInit_SG_PRND_SigGroup_SG_PRND_SigGroup (void)
{
    State_SG_PRND_SigGroup_SG_PRND_SigGroup = &StateVal_SG_PRND_SigGroup_SG_PRND_SigGroup;
    State_SG_PRND_SigGroup_SG_PRND_SigGroup->LastValidCounter = 0;
    State_SG_PRND_SigGroup_SG_PRND_SigGroup->MaxDeltaCounter  = 0;
    State_SG_PRND_SigGroup_SG_PRND_SigGroup->WaitForFirstData = TRUE;
    State_SG_PRND_SigGroup_SG_PRND_SigGroup->NewDataAvailable = FALSE;
    State_SG_PRND_SigGroup_SG_PRND_SigGroup->LostData         = 0;
    State_SG_PRND_SigGroup_SG_PRND_SigGroup->Status           = E2E_P01STATUS_NONEWDATA;
    State_SG_PRND_SigGroup_SG_PRND_SigGroup->SyncCounter      = 0;
    State_SG_PRND_SigGroup_SG_PRND_SigGroup->NoNewOrRepeatedDataCounter = 0;
}

/**********************************************************
 * Function name: E2EPW_Get_ReceiverState_SG_PRND_SigGroup_SG_PRND_SigGroup ()
...
FUNC_P2VAR ( E2E_P01CheckStateType
    ...
    E2EPW_Get_CheckState_SG_PRND_SigGroup_SG_PRND_SigGroup (void)
{
    return State_SG_PRND_SigGroup_SG_PRND_SigGroup;
}

/**********************************************************
 * Function name: E2EPW_Read_SG_PRND_SigGroup_SG_PRND_SigGroup (SG_PRND_SigGroup * AppData);
 ...
 * Remarks:       None
 **********************************************************/
FUNC (uint32, CtAp_CANHandler_CODE) E2EPW_Read_SG_PRND_SigGroup_SG_PRND_SigGroup
    ( P2VAR (SG_PRND_SigGroup, AUTOMATIC, CtAp_CANHandler_VAR_INIT) AppData)
{
    ...
    P2CONST (E2E_P01ConfigType, AUTOMATIC, CtAp_CANHandler_CONST)
        Config_SG_PRND_SigGroup_SG_PRND_SigGroup = &ConfigVal_SG_PRND_SigGroup_SG_PRND_SigGroup;

    State_SG_PRND_SigGroup_SG_PRND_SigGroup->NewDataAvailable =
        Rte_IsUpdated_SG_PRND_SigGroup_SG_PRND_SigGroup ();

    if ((State_SG_PRND_SigGroup_SG_PRND_SigGroup->NewDataAvailable != FALSE))
    {
        if (AppData == NULL_PTR)
        {
        ...
        if (status_u32 == status_ok_u32)
        {
            /* Return-value of Rte_Read does not affect
               following workflow.
            */
            ret_rte_u8 = Rte_Read_SG_PRND_SigGroup_SG_PRND_SigGroup (AppData);
        }

        if (status_u32 == status_ok_u32)
        {
            ret_u8 = E2EPW_CheckDeserial_SG_PRND_SigGroup (AppData);
        ...
        if (status_u32 == status_ok_u32)
        {
            uint16 crcoffset_u16 = Config_SG_PRND_SigGroup_SG_PRND_SigGroup->CRCOffset >> 3u;
            uint16 cntoffset_u16 = Config_SG_PRND_SigGroup_SG_PRND_SigGroup->CounterOffset >> 3u;
            E2EPW_Marshal_SG_PRND_SigGroup ( AppData, ppa_SG_PRND_SigGroup_SG_PRND_SigGroup_au8 );
/**********************************************************
 ...
 **********************************************************/
/* PRQA S 505 1*/
            ppa_SG_PRND_SigGroup_SG_PRND_SigGroup_au8[crcoffset_u16]  = AppData->Checksum_248;
            ppa_SG_PRND_SigGroup_SG_PRND_SigGroup_au8[cntoffset_u16] &= (uint8)0xf0;
            ppa_SG_PRND_SigGroup_SG_PRND_SigGroup_au8[cntoffset_u16] |= AppData->MessageCounter_248;
        }
    }
    ...
    {
        ret_u8 = E2E_P01Check
                     ( Config_SG_PRND_SigGroup_SG_PRND_SigGroup
                     , State_SG_PRND_SigGroup_SG_PRND_SigGroup
                     , ppa_SG_PRND_SigGroup_SG_PRND_SigGroup_au8
                     );
        status_u32 &= 0x80FFFF00U;
        status_u32 |= ret_u8;
        status_u32 |= (uint32)(State_SG_PRND_SigGroup_SG_PRND_SigGroup->Status<<24);
    }
