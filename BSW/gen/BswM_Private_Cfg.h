...
#define BSWM_ID_RULE_CC_CN_LIN00_b12a0454_TCU_LIN_Schedule_740f8639  35u 
...
#define BSWM_ID_AL_CC_AL_CN_LIN00_b12a0454_TCU_LIN_Schedule_740f8639_Disable 47u 
#define BSWM_ID_AL_CC_AL_CN_LIN00_b12a0454_TCU_LIN_Schedule_740f8639_Enable  48u 
...
#define BswM_GetSizeOfRuleStatesOfPCPartitionConfig(partitionIndex)                                 36u  /**< the number of accomplishable value elements in BswM_RuleStates */
#define BswM_GetSizeOfRulesIndOfPCPartitionConfig(partitionIndex)                                   48u  /**< the number of accomplishable value elements in BswM_RulesInd */
#define BswM_GetSizeOfRulesOfPCPartitionConfig(partitionIndex)                                      36u  /**< the number of accomplishable value elements in BswM_Rules */
...
#define BswM_GetExternalIdOfLinScheduleMapping(Index, partitionIndex)                               ComMConf_ComMChannel_CN_LIN00_b12a0454  /**< External id of BswMLinScheduleIndication. */
#define BswM_GetImmediateUserEndIdxOfLinScheduleMapping(Index, partitionIndex)                      10u  /**< the end index of the 0:n relation pointing to BswM_ImmediateUser */
#define BswM_GetImmediateUserStartIdxOfLinScheduleMapping(Index, partitionIndex)                    9u  /**< the start index of the 0:n relation pointing to BswM_ImmediateUser */
...
#include "BswM_vMemMap.h"  /* PRQA S 5087 */  /* MD_MSR_MemMap */
/*lint -restore */
extern CONST(BswM_RulesType, BSWM_CONST) BswM_Rules[36];
#define BSWM_STOP_SEC_CONST_UNSPECIFIED
/*lint -save -esym(961, 19.1) */
#include "BswM_vMemMap.h"  /* PRQA S 5087 */  /* MD_MSR_MemMap */
/*lint -restore */
...
#include "BswM_vMemMap.h"  /* PRQA S 5087 */  /* MD_MSR_MemMap */
/*lint -restore */
extern CONST(BswM_RulesIndType, BSWM_CONST) BswM_RulesInd[48];
