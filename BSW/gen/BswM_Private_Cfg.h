...
#define BswM_GetSizeOfActionListsOfPCPartitionConfig(partitionIndex)                                55u  /**< the number of accomplishable value elements in BswM_ActionLists */
...
#define BswM_GetSizeOfRulesIndOfPCPartitionConfig(partitionIndex)                                   53u  /**< the number of accomplishable value elements in BswM_RulesInd */
...
/*lint -restore */
extern CONST(BswM_ActionListsType, BSWM_CONST) BswM_ActionLists[55];
...
#include "BswM_vMemMap.h"  /* PRQA S 5087 */  /* MD_MSR_MemMap */
/*lint -restore */
extern CONST(BswM_RulesIndType, BSWM_CONST) BswM_RulesInd[53];
