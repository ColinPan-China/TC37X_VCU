...
# define OS_ISR_ASCLIN3ERR_ISR_CORE      (0)
# define OS_ISR_ASCLIN3ERR_ISR_LEVEL     (61)
# define OS_ISR_ASCLIN3RX_ISR_CORE      (0)
# define OS_ISR_ASCLIN3RX_ISR_LEVEL     (60)
# define OS_ISR_ASCLIN3TX_ISR_CORE      (0)
# define OS_ISR_ASCLIN3TX_ISR_LEVEL     (59)
# define OS_ISR_ASCLIN4ERR_ISR_CORE      (0)
# define OS_ISR_ASCLIN4ERR_ISR_LEVEL     (58)
# define OS_ISR_ASCLIN4RX_ISR_CORE      (0)
# define OS_ISR_ASCLIN4RX_ISR_LEVEL     (57)
# define OS_ISR_ASCLIN4TX_ISR_CORE      (0)
# define OS_ISR_ASCLIN4TX_ISR_LEVEL     (56)
# define OS_ISR_CANISR_0_CORE      (0)
# define OS_ISR_CANISR_0_LEVEL     (130)
# define OS_ISR_CANISR_1_CORE      (0)
# define OS_ISR_CANISR_1_LEVEL     (131)
# define OS_ISR_CANISR_3_CORE      (0)
# define OS_ISR_CANISR_3_LEVEL     (134)
# define OS_ISR_CANISR_4_CORE      (0)
# define OS_ISR_CANISR_4_LEVEL     (132)
# define OS_ISR_CANISR_6_CORE      (0)
# define OS_ISR_CANISR_6_LEVEL     (133)
# define OS_ISR_COUNTERISR_SYSTEMTIMER_CORE0_CORE      (0)
# define OS_ISR_COUNTERISR_SYSTEMTIMER_CORE0_LEVEL     (1)
# define OS_ISR_COUNTERISR_SYSTEMTIMER_CORE1_CORE      (1)
# define OS_ISR_COUNTERISR_SYSTEMTIMER_CORE1_LEVEL     (1)
# define OS_ISR_COUNTERISR_SYSTEMTIMER_CORE2_CORE      (2)
# define OS_ISR_COUNTERISR_SYSTEMTIMER_CORE2_LEVEL     (1)
...
# define OS_ISR_GTMTOM0SR2_ISR_LEVEL     (120)
# define OS_ISR_GTMTOM1SR0_ISR_CORE      (0)
# define OS_ISR_GTMTOM1SR0_ISR_LEVEL     (123)
# define OS_ISR_GTMTOM1SR1_ISR_CORE      (0)
# define OS_ISR_GTMTOM1SR1_ISR_LEVEL     (124)
