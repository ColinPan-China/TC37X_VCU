...
const vLinkGen_MemArea vLinkGen_ZeroInit_One_Groups[VLINKGEN_CFG_NUM_ZERO_INIT_ONE_GROUPS] =
{
  ...
  { /*  OS_OsApplication_VAR_FAST_ZERO_INIT  */ 
     /*  .Start  */ (uint32)_OS_OsApplication_VAR_FAST_ZERO_INIT_START, 
     /*  .End  */ (uint32)_lc_ge_OS_OsApplication_VAR_FAST_ZERO_INIT, 
     /*  .Core  */ 0uL, 
     /*  .Alignment  */ 0uL
  }, 
  { /*  OS_OsApplication_VAR_FAST_ZERO_INIT_bss  */ 
     /*  .Start  */ (uint32)_OS_OsApplication_VAR_FAST_ZERO_INIT_bss_START, 
     /*  .End  */ (uint32)_lc_ge_OS_OsApplication_VAR_FAST_ZERO_INIT_bss, 
     /*  .Core  */ 0uL, 
     /*  .Alignment  */ 0uL
  }, 
  { /*  OS_OsApplication_VAR_ZERO_INIT  */ 
     /*  .Start  */ (uint32)_OS_OsApplication_VAR_ZERO_INIT_START, 
     /*  .End  */ (uint32)_lc_ge_OS_OsApplication_VAR_ZERO_INIT, 
     /*  .Core  */ 0uL, 
     /*  .Alignment  */ 0uL
  }, 
  { /*  OS_OsApplication_VAR_ZERO_INIT_bss  */ 
     /*  .Start  */ (uint32)_OS_OsApplication_VAR_ZERO_INIT_bss_START, 
     /*  .End  */ (uint32)_lc_ge_OS_OsApplication_VAR_ZERO_INIT_bss, 
     /*  .Core  */ 0uL, 
     /*  .Alignment  */ 0uL
  }, 
  { /*  bss  */ 
...
const vLinkGen_RamMemArea vLinkGen_Init_One_Groups[VLINKGEN_CFG_NUM_INIT_ONE_GROUPS] =
{
  ...
  { /*  OS_OsApplication_VAR_FAST_INIT  */ 
     /*  .Start  */ (uint32)_OS_OsApplication_VAR_FAST_INIT_START, 
     /*  .End  */ (uint32)_lc_ge_OS_OsApplication_VAR_FAST_INIT, 
     /*  .Romstart  */ (uint32)_OS_OsApplication_VAR_FAST_INIT_ROM_START, 
     /*  .Romend  */ (uint32)_OS_OsApplication_VAR_FAST_INIT_ROM_LIMIT, 
     /*  .Core  */ 0uL, 
     /*  .Alignment  */ 0uL
  }, 
  { /*  OS_OsApplication_VAR_INIT  */ 
     /*  .Start  */ (uint32)_OS_OsApplication_VAR_INIT_START, 
     /*  .End  */ (uint32)_lc_ge_OS_OsApplication_VAR_INIT, 
