...
extern uint8 _OS_OsApplication_VAR_FAST_INIT_ROM_LIMIT[]; 
extern uint8 _OS_OsApplication_VAR_FAST_INIT_ROM_START[]; 
extern uint8 _OS_OsApplication_VAR_FAST_INIT_START[]; 
extern uint8 _OS_OsApplication_VAR_FAST_ZERO_INIT_START[]; 
extern uint8 _OS_OsApplication_VAR_FAST_ZERO_INIT_bss_START[]; 
...
extern uint8 _OS_OsApplication_VAR_ZERO_INIT_bss_START[]; 
...
extern uint8 _lc_ge_OS_OsApplication_VAR_FAST_INIT[]; 
extern uint8 _lc_ge_OS_OsApplication_VAR_FAST_ZERO_INIT[]; 
extern uint8 _lc_ge_OS_OsApplication_VAR_FAST_ZERO_INIT_bss[]; 
extern uint8 _lc_ge_OS_OsApplication_VAR_INIT[]; 
extern uint8 _lc_ge_OS_OsApplication_VAR_ZERO_INIT[]; 
extern uint8 _lc_ge_OS_OsApplication_VAR_ZERO_INIT_bss[]; 
