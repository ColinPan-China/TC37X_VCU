...
extern VAR(Os_Hal_ContextType, OS_VAR_NOINIT) OsCfg_Hal_Context_Core0_Bsw_Task_Dyn;


/*! HAL dynamic task context data: Core0_CddTask */
extern VAR(Os_Hal_ContextType, OS_VAR_NOINIT) OsCfg_Hal_Context_Core0_CddTask_Dyn;
...
extern VAR(Os_Hal_ContextType, OS_VAR_NOINIT) OsCfg_Hal_Context_Core1_Bsw_Task_Dyn;
...
extern VAR(Os_Hal_ContextType, OS_VAR_NOINIT) OsCfg_Hal_Context_Core2_Asw_Init_Dyn;


/*! HAL dynamic task context data: Core2_Asw_Task */
extern VAR(Os_Hal_ContextType, OS_VAR_NOINIT) OsCfg_Hal_Context_Core2_Asw_Task_Dyn;


/*! HAL dynamic task context data: Core2_Bsw_Task */
extern VAR(Os_Hal_ContextType, OS_VAR_NOINIT) OsCfg_Hal_Context_Core2_Bsw_Task_Dyn;
...
extern CONST(Os_Hal_ContextConfigType, OS_CONST) OsCfg_Hal_Context_ASCLIN3ERR_ISR;

/*! HAL ISR2 context configuration data: ASCLIN3RX_ISR */
extern CONST(Os_Hal_ContextConfigType, OS_CONST) OsCfg_Hal_Context_ASCLIN3RX_ISR;

/*! HAL ISR2 context configuration data: ASCLIN3TX_ISR */
extern CONST(Os_Hal_ContextConfigType, OS_CONST) OsCfg_Hal_Context_ASCLIN3TX_ISR;

/*! HAL ISR2 context configuration data: ASCLIN4ERR_ISR */
extern CONST(Os_Hal_ContextConfigType, OS_CONST) OsCfg_Hal_Context_ASCLIN4ERR_ISR;

/*! HAL ISR2 context configuration data: ASCLIN4RX_ISR */
extern CONST(Os_Hal_ContextConfigType, OS_CONST) OsCfg_Hal_Context_ASCLIN4RX_ISR;

/*! HAL ISR2 context configuration data: ASCLIN4TX_ISR */
extern CONST(Os_Hal_ContextConfigType, OS_CONST) OsCfg_Hal_Context_ASCLIN4TX_ISR;
...
extern CONST(Os_Hal_ContextConfigType, OS_CONST) OsCfg_Hal_Context_CanIsr_6;
...
extern CONST(Os_Hal_ContextConfigType, OS_CONST) OsCfg_Hal_Context_GTMTOM1SR1_ISR;
...
extern CONST(Os_Hal_ContextConfigType, OS_CONST) OsCfg_Hal_Context_Core0_CddTask;
...
extern CONST(Os_Hal_ContextConfigType, OS_CONST) OsCfg_Hal_Context_Core2_Asw_Init;

/*! HAL task context configuration data: Core2_Asw_Task */
extern CONST(Os_Hal_ContextConfigType, OS_CONST) OsCfg_Hal_Context_Core2_Asw_Task;

/*! HAL task context configuration data: Core2_Bsw_Task */
extern CONST(Os_Hal_ContextConfigType, OS_CONST) OsCfg_Hal_Context_Core2_Bsw_Task;
