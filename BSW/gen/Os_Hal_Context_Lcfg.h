...
extern VAR(Os_Hal_ContextType, OS_VAR_NOINIT) OsCfg_Hal_Context_Core0_BswTask_Dyn;
...
extern VAR(Os_Hal_ContextType, OS_VAR_NOINIT) OsCfg_Hal_Context_Core1_AswInit_Dyn;


/*! HAL dynamic task context data: Core1_AswTask */
extern VAR(Os_Hal_ContextType, OS_VAR_NOINIT) OsCfg_Hal_Context_Core1_AswTask_Dyn;


/*! HAL dynamic task context data: Core1_BswTask */
extern VAR(Os_Hal_ContextType, OS_VAR_NOINIT) OsCfg_Hal_Context_Core1_BswTask_Dyn;
...
extern VAR(Os_Hal_ContextType, OS_VAR_NOINIT) OsCfg_Hal_Context_Core2_AswInit_Dyn;


/*! HAL dynamic task context data: Core2_AswTask */
extern VAR(Os_Hal_ContextType, OS_VAR_NOINIT) OsCfg_Hal_Context_Core2_AswTask_Dyn;


/*! HAL dynamic task context data: Core2_BswTask */
extern VAR(Os_Hal_ContextType, OS_VAR_NOINIT) OsCfg_Hal_Context_Core2_BswTask_Dyn;
...
extern CONST(Os_Hal_ContextConfigType, OS_CONST) OsCfg_Hal_Context_ADC11SR0_ISR;
...
extern CONST(Os_Hal_ContextConfigType, OS_CONST) OsCfg_Hal_Context_ASCLIN2RX_ISR;

/*! HAL ISR2 context configuration data: ASCLIN2TX_ISR */
extern CONST(Os_Hal_ContextConfigType, OS_CONST) OsCfg_Hal_Context_ASCLIN2TX_ISR;
...
extern CONST(Os_Hal_ContextConfigType, OS_CONST) OsCfg_Hal_Context_DMACH10SR_ISR;
...
extern CONST(Os_Hal_ContextConfigType, OS_CONST) OsCfg_Hal_Context_EthIsr_EthCtrlConfig_ETHSR2_ISR;

/*! HAL ISR2 context configuration data: EthIsr_EthCtrlConfig_ETHSR6_ISR */
extern CONST(Os_Hal_ContextConfigType, OS_CONST) OsCfg_Hal_Context_EthIsr_EthCtrlConfig_ETHSR6_ISR;

/*! HAL ISR2 context configuration data: GTMTOM1SR3_ISR */
extern CONST(Os_Hal_ContextConfigType, OS_CONST) OsCfg_Hal_Context_GTMTOM1SR3_ISR;

/*! HAL ISR2 context configuration data: GTMTOM1SR4_ISR */
extern CONST(Os_Hal_ContextConfigType, OS_CONST) OsCfg_Hal_Context_GTMTOM1SR4_ISR;
...
extern CONST(Os_Hal_ContextConfigType, OS_CONST) OsCfg_Hal_Context_Core1_AswInit;

/*! HAL task context configuration data: Core1_AswTask */
extern CONST(Os_Hal_ContextConfigType, OS_CONST) OsCfg_Hal_Context_Core1_AswTask;

/*! HAL task context configuration data: Core1_BswTask */
extern CONST(Os_Hal_ContextConfigType, OS_CONST) OsCfg_Hal_Context_Core1_BswTask;
...
extern CONST(Os_Hal_ContextConfigType, OS_CONST) OsCfg_Hal_Context_Core2_AswInit;

/*! HAL task context configuration data: Core2_AswTask */
extern CONST(Os_Hal_ContextConfigType, OS_CONST) OsCfg_Hal_Context_Core2_AswTask;

/*! HAL task context configuration data: Core2_BswTask */
extern CONST(Os_Hal_ContextConfigType, OS_CONST) OsCfg_Hal_Context_Core2_BswTask;
