 ...
 ** Module: E2EPW_Com_SWC_SG_IBS_Status_06_Signal_Group_SG_IBS_Status_06_Signal_Group_rx.c
 ** Mon, 28-Jul-2025, 09:21:18
 **/
...
#include "E2EPW_CheckDeserial_SG_IBS_Status_06_Signal_Group.h"
...
STATIC VAR (E2E_P01CheckStateType, Com_SWC_VAR_INIT)
    StateVal_SG_IBS_Status_06_Signal_Group_SG_IBS_Status_06_Signal_Group =
{
      0                        /* LastValidCounter */
    , 0                        /* MaxDeltaCounter  */
...
STATIC P2VAR ( E2E_P01CheckStateType
    ...
    State_SG_IBS_Status_06_Signal_Group_SG_IBS_Status_06_Signal_Group =
        &StateVal_SG_IBS_Status_06_Signal_Group_SG_IBS_Status_06_Signal_Group;
...
STATIC VAR (uint8, Com_SWC_VAR_NOINIT)
    ppa_SG_IBS_Status_06_Signal_Group_SG_IBS_Status_06_Signal_Group_au8 [8];
...
STATIC CONST (E2E_P01ConfigType, Com_SWC_CONST)
    ConfigVal_SG_IBS_Status_06_Signal_Group_SG_IBS_Status_06_Signal_Group =
{
      8
    , 0
    , 188
 ...
 **********************************************************/
FUNC (void, Com_SWC_CODE) E2EPW_ReadInit_SG_IBS_Status_06_Signal_Group_SG_IBS_Status_06_Signal_Group (void)
{
    State_SG_IBS_Status_06_Signal_Group_SG_IBS_Status_06_Signal_Group = &StateVal_SG_IBS_Status_06_Signal_Group_SG_IBS_Status_06_Signal_Group;
    State_SG_IBS_Status_06_Signal_Group_SG_IBS_Status_06_Signal_Group->LastValidCounter = 0;
    State_SG_IBS_Status_06_Signal_Group_SG_IBS_Status_06_Signal_Group->MaxDeltaCounter  = 0;
    State_SG_IBS_Status_06_Signal_Group_SG_IBS_Status_06_Signal_Group->WaitForFirstData = TRUE;
    State_SG_IBS_Status_06_Signal_Group_SG_IBS_Status_06_Signal_Group->NewDataAvailable = FALSE;
    State_SG_IBS_Status_06_Signal_Group_SG_IBS_Status_06_Signal_Group->LostData         = 0;
    State_SG_IBS_Status_06_Signal_Group_SG_IBS_Status_06_Signal_Group->Status           = E2E_P01STATUS_NONEWDATA;
    State_SG_IBS_Status_06_Signal_Group_SG_IBS_Status_06_Signal_Group->SyncCounter      = 0;
    State_SG_IBS_Status_06_Signal_Group_SG_IBS_Status_06_Signal_Group->NoNewOrRepeatedDataCounter = 0;
}
...
{
    return State_SG_IBS_Status_06_Signal_Group_SG_IBS_Status_06_Signal_Group;
}
 ...
 * Remarks:       None
 **********************************************************/
FUNC (uint32, Com_SWC_CODE) E2EPW_Read_SG_IBS_Status_06_Signal_Group_SG_IBS_Status_06_Signal_Group
    ( P2VAR (SG_IBS_Status_06_Signal_Group, AUTOMATIC, Com_SWC_VAR_INIT) AppData)
{
    ...
    P2CONST (E2E_P01ConfigType, AUTOMATIC, Com_SWC_CONST)
        Config_SG_IBS_Status_06_Signal_Group_SG_IBS_Status_06_Signal_Group = &ConfigVal_SG_IBS_Status_06_Signal_Group_SG_IBS_Status_06_Signal_Group;

    State_SG_IBS_Status_06_Signal_Group_SG_IBS_Status_06_Signal_Group->NewDataAvailable =
        Rte_IsUpdated_SG_IBS_Status_06_Signal_Group_SG_IBS_Status_06_Signal_Group ();

    if ((State_SG_IBS_Status_06_Signal_Group_SG_IBS_Status_06_Signal_Group->NewDataAvailable != FALSE))
    {
        if (AppData == NULL_PTR)
        {
        ...
        if (status_u32 == status_ok_u32)
        {
            /* Return-value of Rte_Read does not affect
               following workflow.
            */
            ret_rte_u8 = Rte_Read_SG_IBS_Status_06_Signal_Group_SG_IBS_Status_06_Signal_Group (AppData);
        }

        if (status_u32 == status_ok_u32)
        {
            ret_u8 = E2EPW_CheckDeserial_SG_IBS_Status_06_Signal_Group (AppData);
        ...
        if (status_u32 == status_ok_u32)
        {
            uint16 crcoffset_u16 = Config_SG_IBS_Status_06_Signal_Group_SG_IBS_Status_06_Signal_Group->CRCOffset >> 3u;
            uint16 cntoffset_u16 = Config_SG_IBS_Status_06_Signal_Group_SG_IBS_Status_06_Signal_Group->CounterOffset >> 3u;
            E2EPW_Marshal_SG_IBS_Status_06_Signal_Group ( AppData, ppa_SG_IBS_Status_06_Signal_Group_SG_IBS_Status_06_Signal_Group_au8 );
/**********************************************************
 ...
 **********************************************************/
/* PRQA S 505 1*/
            ppa_SG_IBS_Status_06_Signal_Group_SG_IBS_Status_06_Signal_Group_au8[crcoffset_u16]  = AppData->Checksum_0BC;
            ppa_SG_IBS_Status_06_Signal_Group_SG_IBS_Status_06_Signal_Group_au8[cntoffset_u16] &= (uint8)0xf0;
            ppa_SG_IBS_Status_06_Signal_Group_SG_IBS_Status_06_Signal_Group_au8[cntoffset_u16] |= AppData->MessageCounter_0BC;
        }
    }
    ...
    {
        ret_u8 = E2E_P01Check
                     ( Config_SG_IBS_Status_06_Signal_Group_SG_IBS_Status_06_Signal_Group
                     , State_SG_IBS_Status_06_Signal_Group_SG_IBS_Status_06_Signal_Group
                     , ppa_SG_IBS_Status_06_Signal_Group_SG_IBS_Status_06_Signal_Group_au8
                     );
        status_u32 &= 0x80FFFF00U;
        status_u32 |= ret_u8;
        status_u32 |= (uint32)(State_SG_IBS_Status_06_Signal_Group_SG_IBS_Status_06_Signal_Group->Status<<24);
    }
