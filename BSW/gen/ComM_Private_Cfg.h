...
#define ComM_GetSizeOfChannelOfPCPartitionConfig()                                                  9u  /**< the number of accomplishable value elements in ComM_Channel */
#define ComM_GetSizeOfChannelPbOfPCPartitionConfig()                                                9u  /**< the number of accomplishable value elements in ComM_ChannelPb */
...
#define ComM_GetSizeOfUserReqFullComOfPCPartitionConfig(partitionIndex)                             9u  /**< the number of accomplishable value elements in ComM_UserReqFullCom */
