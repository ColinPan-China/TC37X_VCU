 ...
 ** Module: E2EPW_CtAp_CANHandler_SG_VCU_MCU_03_SigGroup_1_SG_VCU_MCU_03_SigGroup_tx.c
...
#include "E2EPW_CtAp_CANHandler_SG_VCU_MCU_03_SigGroup_1_SG_VCU_MCU_03_SigGroup_tx.h"
#ifndef STATIC
...
STATIC VAR (E2E_P01ProtectStateType, CtAp_CANHandler_VAR_INIT)
    StateVal_SG_VCU_MCU_03_SigGroup_1_SG_VCU_MCU_03_SigGroup =
{
    0  /* Counter */
};
...
STATIC P2VAR ( E2E_P01ProtectStateType
    ...
    State_SG_VCU_MCU_03_SigGroup_1_SG_VCU_MCU_03_SigGroup =
        &StateVal_SG_VCU_MCU_03_SigGroup_1_SG_VCU_MCU_03_SigGroup;
...
STATIC VAR (uint8, CtAp_CANHandler_VAR_NOINIT)
    ppa_SG_VCU_MCU_03_SigGroup_1_SG_VCU_MCU_03_SigGroup_au8 [8];
...
STATIC CONST (E2E_P01ConfigType, CtAp_CANHandler_CONST)
    ConfigVal_SG_VCU_MCU_03_SigGroup_1_SG_VCU_MCU_03_SigGroup =
{
      8
    , 0
    , 149
...
/**********************************************************
 * Function name: E2EPW_Init_SG_VCU_MCU_03_SigGroup_1_SG_VCU_MCU_03_SigGroup_tx ()
 ...
 **********************************************************/
FUNC (void, CtAp_CANHandler_CODE) E2EPW_WriteInit_SG_VCU_MCU_03_SigGroup_1_SG_VCU_MCU_03_SigGroup (void)
{
    State_SG_VCU_MCU_03_SigGroup_1_SG_VCU_MCU_03_SigGroup = &StateVal_SG_VCU_MCU_03_SigGroup_1_SG_VCU_MCU_03_SigGroup;
    State_SG_VCU_MCU_03_SigGroup_1_SG_VCU_MCU_03_SigGroup->Counter = 0;
}

/**********************************************************
 * Function name: E2EPW_Get_SenderState_SG_VCU_MCU_03_SigGroup_1_SG_VCU_MCU_03_SigGroup ()
...
FUNC_P2VAR ( E2E_P01ProtectStateType
    ...
    E2EPW_Get_ProtectState_SG_VCU_MCU_03_SigGroup_1_SG_VCU_MCU_03_SigGroup (void)
{
    return State_SG_VCU_MCU_03_SigGroup_1_SG_VCU_MCU_03_SigGroup;
}

/**********************************************************
 * Function name: E2EPW_Write_SG_VCU_MCU_03_SigGroup_1_SG_VCU_MCU_03_SigGroup (SG_VCU_MCU_03_SigGroup *  AppData);
 ...
 * Remarks:       None
 **********************************************************/
FUNC (uint32, CtAp_CANHandler_CODE) E2EPW_Write_SG_VCU_MCU_03_SigGroup_1_SG_VCU_MCU_03_SigGroup
    (P2VAR (SG_VCU_MCU_03_SigGroup, AUTOMATIC, CtAp_CANHandler_VAR_INIT) AppData)
{
    ...
    P2CONST (E2E_P01ConfigType, AUTOMATIC, CtAp_CANHandler_CONST)
        Config_SG_VCU_MCU_03_SigGroup_1_SG_VCU_MCU_03_SigGroup = &ConfigVal_SG_VCU_MCU_03_SigGroup_1_SG_VCU_MCU_03_SigGroup;
    ...
    {
        E2EPW_Marshal_SG_VCU_MCU_03_SigGroup ( AppData, ppa_SG_VCU_MCU_03_SigGroup_1_SG_VCU_MCU_03_SigGroup_au8 );
    }

    if (status_u32 == status_ok_u32)
    {
        ret_u8 = E2E_P01Protect
                     ( Config_SG_VCU_MCU_03_SigGroup_1_SG_VCU_MCU_03_SigGroup
                     , State_SG_VCU_MCU_03_SigGroup_1_SG_VCU_MCU_03_SigGroup
                     , ppa_SG_VCU_MCU_03_SigGroup_1_SG_VCU_MCU_03_SigGroup_au8
                     );
    ...
    if (status_u32 == status_ok_u32)
    {
        uint16 crcoffset_u16 = Config_SG_VCU_MCU_03_SigGroup_1_SG_VCU_MCU_03_SigGroup->CRCOffset/8;
        uint16 cntoffset_u16 = Config_SG_VCU_MCU_03_SigGroup_1_SG_VCU_MCU_03_SigGroup->CounterOffset/8;
/**********************************************************
 ...
 **********************************************************/
/* PRQA S 505 1*/
        AppData->Checksum_095 = ppa_SG_VCU_MCU_03_SigGroup_1_SG_VCU_MCU_03_SigGroup_au8[crcoffset_u16];
        AppData->MessageCounter_095 = (ppa_SG_VCU_MCU_03_SigGroup_1_SG_VCU_MCU_03_SigGroup_au8[cntoffset_u16] & 0x0F);
    }

    if (status_u32 == status_ok_u32)
    {
        ret_u8 = Rte_Write_SG_VCU_MCU_03_SigGroup_1_SG_VCU_MCU_03_SigGroup ( AppData );
