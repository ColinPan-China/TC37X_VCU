...
/*! Dynamic ISR data: ASCLIN3ERR_ISR */
OS_LOCAL VAR(Os_IsrType, OS_VAR_NOINIT) OsCfg_Isr_ASCLIN3ERR_ISR_Dyn;

/*! Dynamic ISR data: ASCLIN3RX_ISR */
OS_LOCAL VAR(Os_IsrType, OS_VAR_NOINIT) OsCfg_Isr_ASCLIN3RX_ISR_Dyn;

/*! Dynamic ISR data: ASCLIN3TX_ISR */
OS_LOCAL VAR(Os_IsrType, OS_VAR_NOINIT) OsCfg_Isr_ASCLIN3TX_ISR_Dyn;

/*! Dynamic ISR data: ASCLIN4ERR_ISR */
OS_LOCAL VAR(Os_IsrType, OS_VAR_NOINIT) OsCfg_Isr_ASCLIN4ERR_ISR_Dyn;

/*! Dynamic ISR data: ASCLIN4RX_ISR */
OS_LOCAL VAR(Os_IsrType, OS_VAR_NOINIT) OsCfg_Isr_ASCLIN4RX_ISR_Dyn;

/*! Dynamic ISR data: ASCLIN4TX_ISR */
OS_LOCAL VAR(Os_IsrType, OS_VAR_NOINIT) OsCfg_Isr_ASCLIN4TX_ISR_Dyn;
...
/*! Dynamic ISR data: GTMTOM1SR1_ISR */
OS_LOCAL VAR(Os_IsrType, OS_VAR_NOINIT) OsCfg_Isr_GTMTOM1SR1_ISR_Dyn;
...
CONST(Os_IsrHwConfigType, OS_CONST) OsCfg_Isr_ASCLIN3ERR_ISR_HwConfig =
{
  /* .HwConfig                  = */ &OsCfg_Hal_IntIsr_ASCLIN3ERR_ISR,
  /* .MapConfig                 = */ &OsCfg_Hal_IntIsrMap_ASCLIN3ERR_ISR,
  /* .IsMapped                  = */ FALSE,
  /* .IsPostActionRequired      = */ FALSE
}
;  
CONST(Os_IsrConfigType, OS_CONST) OsCfg_Isr_ASCLIN3ERR_ISR =
{
  /* .Thread   = */
  {
  ...
  /* .SourceConfig              = */ &OsCfg_Isr_ASCLIN3ERR_ISR_HwConfig,
  /* .IsrId                     = */ ASCLIN3ERR_ISR,
  /* .IsEnabledOnInitialization = */ TRUE
}
;
/*! ISR configuration data: ASCLIN3RX_ISR */
CONST(Os_IsrHwConfigType, OS_CONST) OsCfg_Isr_ASCLIN3RX_ISR_HwConfig =
{
  /* .HwConfig                  = */ &OsCfg_Hal_IntIsr_ASCLIN3RX_ISR,
  /* .MapConfig                 = */ &OsCfg_Hal_IntIsrMap_ASCLIN3RX_ISR,
  /* .IsMapped                  = */ FALSE,
  /* .IsPostActionRequired      = */ FALSE
}
;  
CONST(Os_IsrConfigType, OS_CONST) OsCfg_Isr_ASCLIN3RX_ISR =
{
  /* .Thread   = */
  {
  ...
  /* .SourceConfig              = */ &OsCfg_Isr_ASCLIN3RX_ISR_HwConfig,
  /* .IsrId                     = */ ASCLIN3RX_ISR,
  /* .IsEnabledOnInitialization = */ TRUE
}
;
/*! ISR configuration data: ASCLIN3TX_ISR */
CONST(Os_IsrHwConfigType, OS_CONST) OsCfg_Isr_ASCLIN3TX_ISR_HwConfig =
{
  /* .HwConfig                  = */ &OsCfg_Hal_IntIsr_ASCLIN3TX_ISR,
  /* .MapConfig                 = */ &OsCfg_Hal_IntIsrMap_ASCLIN3TX_ISR,
  /* .IsMapped                  = */ FALSE,
  /* .IsPostActionRequired      = */ FALSE
}
;  
CONST(Os_IsrConfigType, OS_CONST) OsCfg_Isr_ASCLIN3TX_ISR =
{
  /* .Thread   = */
  {
  ...
  /* .SourceConfig              = */ &OsCfg_Isr_ASCLIN3TX_ISR_HwConfig,
  /* .IsrId                     = */ ASCLIN3TX_ISR,
  /* .IsEnabledOnInitialization = */ TRUE
}
;
/*! ISR configuration data: ASCLIN4ERR_ISR */
CONST(Os_IsrHwConfigType, OS_CONST) OsCfg_Isr_ASCLIN4ERR_ISR_HwConfig =
{
  /* .HwConfig                  = */ &OsCfg_Hal_IntIsr_ASCLIN4ERR_ISR,
  /* .MapConfig                 = */ &OsCfg_Hal_IntIsrMap_ASCLIN4ERR_ISR,
  /* .IsMapped                  = */ FALSE,
  /* .IsPostActionRequired      = */ FALSE
}
;  
CONST(Os_IsrConfigType, OS_CONST) OsCfg_Isr_ASCLIN4ERR_ISR =
{
  /* .Thread   = */
  {
  ...
  /* .SourceConfig              = */ &OsCfg_Isr_ASCLIN4ERR_ISR_HwConfig,
  /* .IsrId                     = */ ASCLIN4ERR_ISR,
  /* .IsEnabledOnInitialization = */ TRUE
}
;
/*! ISR configuration data: ASCLIN4RX_ISR */
CONST(Os_IsrHwConfigType, OS_CONST) OsCfg_Isr_ASCLIN4RX_ISR_HwConfig =
{
  /* .HwConfig                  = */ &OsCfg_Hal_IntIsr_ASCLIN4RX_ISR,
  /* .MapConfig                 = */ &OsCfg_Hal_IntIsrMap_ASCLIN4RX_ISR,
  /* .IsMapped                  = */ FALSE,
  /* .IsPostActionRequired      = */ FALSE
}
;  
CONST(Os_IsrConfigType, OS_CONST) OsCfg_Isr_ASCLIN4RX_ISR =
{
  /* .Thread   = */
  {
  ...
  /* .SourceConfig              = */ &OsCfg_Isr_ASCLIN4RX_ISR_HwConfig,
  /* .IsrId                     = */ ASCLIN4RX_ISR,
  /* .IsEnabledOnInitialization = */ TRUE
}
;
/*! ISR configuration data: ASCLIN4TX_ISR */
CONST(Os_IsrHwConfigType, OS_CONST) OsCfg_Isr_ASCLIN4TX_ISR_HwConfig =
{
  /* .HwConfig                  = */ &OsCfg_Hal_IntIsr_ASCLIN4TX_ISR,
  /* .MapConfig                 = */ &OsCfg_Hal_IntIsrMap_ASCLIN4TX_ISR,
  /* .IsMapped                  = */ FALSE,
  /* .IsPostActionRequired      = */ FALSE
}
;  
CONST(Os_IsrConfigType, OS_CONST) OsCfg_Isr_ASCLIN4TX_ISR =
{
  /* .Thread   = */
  {
  ...
  /* .SourceConfig              = */ &OsCfg_Isr_ASCLIN4TX_ISR_HwConfig,
  /* .IsrId                     = */ ASCLIN4TX_ISR,
  /* .IsEnabledOnInitialization = */ TRUE
}
;
...
CONST(Os_IsrHwConfigType, OS_CONST) OsCfg_Isr_CanIsr_2_HwConfig =
{
  /* .HwConfig                  = */ &OsCfg_Hal_IntIsr_CanIsr_2,
  /* .MapConfig                 = */ &OsCfg_Hal_IntIsrMap_CanIsr_2,
  /* .IsMapped                  = */ FALSE,
  /* .IsPostActionRequired      = */ FALSE
}
;  
CONST(Os_IsrConfigType, OS_CONST) OsCfg_Isr_CanIsr_2 =
{
  ...
  /* .SourceConfig              = */ &OsCfg_Isr_CanIsr_2_HwConfig,
  /* .IsrId                     = */ CanIsr_2,
  /* .IsEnabledOnInitialization = */ TRUE
}
;
...
CONST(Os_IsrHwConfigType, OS_CONST) OsCfg_Isr_CanIsr_6_HwConfig =
{
  /* .HwConfig                  = */ &OsCfg_Hal_IntIsr_CanIsr_6,
  /* .MapConfig                 = */ &OsCfg_Hal_IntIsrMap_CanIsr_6,
  /* .IsMapped                  = */ FALSE,
  /* .IsPostActionRequired      = */ FALSE
}
;  
CONST(Os_IsrConfigType, OS_CONST) OsCfg_Isr_CanIsr_6 =
{
  /* .Thread   = */
  {
  ...
  /* .SourceConfig              = */ &OsCfg_Isr_CanIsr_6_HwConfig,
  /* .IsrId                     = */ CanIsr_6,
  /* .IsEnabledOnInitialization = */ TRUE
}
;
...
{
  /* .HwConfig                  = */ &OsCfg_Hal_IntIsr_GTMTOM1SR0_ISR,
  /* .MapConfig                 = */ &OsCfg_Hal_IntIsrMap_GTMTOM1SR0_ISR,
  /* .IsMapped                  = */ FALSE,
  /* .IsPostActionRequired      = */ FALSE
}
;  
CONST(Os_IsrConfigType, OS_CONST) OsCfg_Isr_GTMTOM1SR0_ISR =
{
  /* .Thread   = */
  {
  ...
  /* .SourceConfig              = */ &OsCfg_Isr_GTMTOM1SR0_ISR_HwConfig,
  /* .IsrId                     = */ GTMTOM1SR0_ISR,
  /* .IsEnabledOnInitialization = */ TRUE
}
;
/*! ISR configuration data: GTMTOM1SR1_ISR */
CONST(Os_IsrHwConfigType, OS_CONST) OsCfg_Isr_GTMTOM1SR1_ISR_HwConfig =
{
  /* .HwConfig                  = */ &OsCfg_Hal_IntIsr_GTMTOM1SR1_ISR,
  /* .MapConfig                 = */ &OsCfg_Hal_IntIsrMap_GTMTOM1SR1_ISR,
  /* .IsMapped                  = */ FALSE,
  /* .IsPostActionRequired      = */ FALSE
}
;  
CONST(Os_IsrConfigType, OS_CONST) OsCfg_Isr_GTMTOM1SR1_ISR =
{
  /* .Thread   = */
  {
  ...
  /* .SourceConfig              = */ &OsCfg_Isr_GTMTOM1SR1_ISR_HwConfig,
  /* .IsrId                     = */ GTMTOM1SR1_ISR,
  /* .IsEnabledOnInitialization = */ TRUE
}
;
