...
/* Stack: Core1_Asw_Task_Qm (1024 Byte) */
group OS_STACK_CORE1_ASW_TASK_QM_VAR_NOINIT_GROUP(ordered, contiguous, fill, align=8)
{
  select "[.]bss.OS_STACK_CORE1_ASW_TASK_QM_VAR_NOINIT";
}
"_OS_STACK_CORE1_ASW_TASK_QM_VAR_NOINIT_START" = "_lc_gb_OS_STACK_CORE1_ASW_TASK_QM_VAR_NOINIT_GROUP";
"_OS_STACK_CORE1_ASW_TASK_QM_VAR_NOINIT_END" = "_lc_ge_OS_STACK_CORE1_ASW_TASK_QM_VAR_NOINIT_GROUP" - 1;
"_OS_STACK_CORE1_ASW_TASK_QM_VAR_NOINIT_LIMIT" = "_lc_ge_OS_STACK_CORE1_ASW_TASK_QM_VAR_NOINIT_GROUP";

/* Stack: Core1_Bsw_Task (1024 Byte) */
group OS_STACK_CORE1_BSW_TASK_VAR_NOINIT_GROUP(ordered, contiguous, fill, align=8)
{
  select "[.]bss.OS_STACK_CORE1_BSW_TASK_VAR_NOINIT";
}
"_OS_STACK_CORE1_BSW_TASK_VAR_NOINIT_START" = "_lc_gb_OS_STACK_CORE1_BSW_TASK_VAR_NOINIT_GROUP";
"_OS_STACK_CORE1_BSW_TASK_VAR_NOINIT_END" = "_lc_ge_OS_STACK_CORE1_BSW_TASK_VAR_NOINIT_GROUP" - 1;
"_OS_STACK_CORE1_BSW_TASK_VAR_NOINIT_LIMIT" = "_lc_ge_OS_STACK_CORE1_BSW_TASK_VAR_NOINIT_GROUP";
