 ...
 ** Module: E2EPW_Marshal_SG_VCU_BMS_SigGroup.c
...
/******************************************************************
 * Function name      : E2EPW_Marshal_SG_VCU_BMS_SigGroup
 ...
 * Remarks            : none
 ******************************************************************/
FUNC (void, E2EPW_CODE) E2EPW_Marshal_SG_VCU_BMS_SigGroup
    ( P2CONST (SG_VCU_BMS_SigGroup, AUTOMATIC, E2EPW_APPL_DATA) pde
    ...
    )
{
    ...
    /* packing signal VCU_BMS_Control_of_PosRelay */
    src = (P2CONST (uint8, AUTOMATIC, E2EPW_APPL_DATA)) &(pde->VCU_BMS_Control_of_PosRelay);
    ppa[6] |= (src[0] << 4) & 0x30;
    ...
    /* packing signal VCU_IsoMeasurementSwitch */
    src = (P2CONST (uint8, AUTOMATIC, E2EPW_APPL_DATA)) &(pde->VCU_IsoMeasurementSwitch);
    ppa[1] &= 0x0f;
    ppa[1] |= (src[0] << 6) & 0x40;
