...
/* Generator Internal Version                                         21.05.00 (Cfg5.16.x/Cfg5.17.x/Cfg5.18.x compatible, Release AR4-24), Revision: 140150, Variant: MICROSAR/Generic (Vector) */
...
#define DEM_CFG_SUPPORT_CYCLE_POWER                                        STD_ON       /* Autodetected - STD_ON: cycle type is referenced by any *CycleRef or the /Dem/DemGeneral/DemRestartCycleOnInitRef parameter, STD_OFF: cycle type is not referenced. The '*CycleRef' params are (here 212 refs): /Dem/DemConfigSet/DemEventParameter/DemEventClass/DemAgingCycleRef, ~/DemOperationCycleRef, ~/DemIndicatorAttribute/DemIndicatorFailureCycleRef and ~/DemIndicatorAttribute/DemIndicatorHealingCycleRef. */ 
...
#define DEM_CFG_SUPPORT_SRECS_CALCULATED                                   STD_OFF      /* Autodetected - via /Dem/DemGeneral/DemTypeOfFreezeFrameRecordNumeration == DEM_FF_RECNUM_CALCULATED or DEM_FF_RECNUM_CALCULATED_FIFO */ 
...
#endif
#ifndef DEM_PROCESSOR_TC377T
#define DEM_PROCESSOR_TC377T
#endif
...
#define DEM_CFG_DIAGNOSTIC_OEM                                        DEM_OEM_MICROSAR_GENERIC
...
#endif  /* DEM_CFG_H */
/**********************************************************************************************************************
  END OF FILE: Dem_Cfg.h     [MICROSAR/Generic (Vector), VARIANT-PRE-COMPILE, 21.05.00.140150]
**********************************************************************************************************************/
