 ...
 *   Generation Time: 2025-09-04 10:59:04
...
#define ETHIF_NO_ETHERTYPEOFUSER                                      255u
...
#define ETHIF_ISDEF_SIZEOFETHCTRLRXFRAMECNTOFPCCONFIG                 STD_OFF
...
#define ETHIF_EQ2_SIZEOFETHCTRLRXFRAMECNTOFPCCONFIG                   
...
#define ETHIF_INIT_DATA_HASH_CODE                                     1699638118  /**< the precompile constant to validate the initialization structure at initialization time of EthIf with a hashcode. The seed value is '0x891Eu' */
...
typedef uint8_least EthIf_EthCtrlRxFrameCntIterType;
...
typedef uint8 EthIf_EtherTypeOfUserType;
...
{
  EthIf_TxContextType EthCtrlConfig[2];
...
typedef struct sEthIf_PCConfigType
{
  ...
  EthIf_SizeOfEthCtrlRxFrameCntType SizeOfEthCtrlRxFrameCntOfPCConfig;  /**< the number of accomplishable value elements in EthIf_EthCtrlRxFrameCnt */
...
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_MemMap */
/*lint -restore */
extern CONST(EthIf_RxIndFctPtrType, ETHIF_CONST) EthIf_RxIndications[1];
#define ETHIF_STOP_SEC_CONST_UNSPECIFIED
/*lint -save -esym(961, 19.1) */
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_MemMap */
/*lint -restore */
...
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_MemMap */
/*lint -restore */
extern CONST(EthIf_RxIndicationsIndType, ETHIF_CONST) EthIf_RxIndicationsInd[1];
#define ETHIF_STOP_SEC_CONST_8BIT
/*lint -save -esym(961, 19.1) */
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_MemMap */
/*lint -restore */
...
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_MemMap */
/*lint -restore */
extern CONST(EthIf_TxConfFctPtrType, ETHIF_CONST) EthIf_TxConfirmations[1];
#define ETHIF_STOP_SEC_CONST_UNSPECIFIED
/*lint -save -esym(961, 19.1) */
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_MemMap */
/*lint -restore */
...
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_MemMap */
/*lint -restore */
extern CONST(EthIf_TxConfirmationsIndType, ETHIF_CONST) EthIf_TxConfirmationsInd[1];
#define ETHIF_STOP_SEC_CONST_8BIT
/*lint -save -esym(961, 19.1) */
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_MemMap */
/*lint -restore */
...
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_MemMap */
/*lint -restore */
extern CONST(EthIf_UserType, ETHIF_CONST) EthIf_User[1];
#define ETHIF_STOP_SEC_CONST_UNSPECIFIED
/*lint -save -esym(961, 19.1) */
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_MemMap */
/*lint -restore */
