...
extern CONST(Os_IsrConfigType, OS_CONST) OsCfg_Isr_ASCLIN4ERR_ISR;

/*! ISR configuration data: ASCLIN4RX_ISR */
extern CONST(Os_IsrHwConfigType, OS_CONST) OsCfg_Isr_ASCLIN4RX_ISR_HwConfig;
extern CONST(Os_IsrConfigType, OS_CONST) OsCfg_Isr_ASCLIN4RX_ISR;

/*! ISR configuration data: ASCLIN4TX_ISR */
extern CONST(Os_IsrHwConfigType, OS_CONST) OsCfg_Isr_ASCLIN4TX_ISR_HwConfig;
extern CONST(Os_IsrConfigType, OS_CONST) OsCfg_Isr_ASCLIN4TX_ISR;
...
extern CONST(Os_IsrHwConfigType, OS_CONST) OsCfg_Isr_GTMTIM2SR4_ISR_HwConfig;
extern CONST(Os_IsrConfigType, OS_CONST) OsCfg_Isr_GTMTIM2SR4_ISR;

/*! ISR configuration data: GTMTIM2SR6_ISR */
extern CONST(Os_IsrHwConfigType, OS_CONST) OsCfg_Isr_GTMTIM2SR6_ISR_HwConfig;
extern CONST(Os_IsrConfigType, OS_CONST) OsCfg_Isr_GTMTIM2SR6_ISR;

/*! ISR configuration data: GTMTOM1SR0_ISR */
extern CONST(Os_IsrHwConfigType, OS_CONST) OsCfg_Isr_GTMTOM1SR0_ISR_HwConfig;
extern CONST(Os_IsrConfigType, OS_CONST) OsCfg_Isr_GTMTOM1SR0_ISR;

/*! ISR configuration data: GTMTOM1SR1_ISR */
extern CONST(Os_IsrHwConfigType, OS_CONST) OsCfg_Isr_GTMTOM1SR1_ISR_HwConfig;
extern CONST(Os_IsrConfigType, OS_CONST) OsCfg_Isr_GTMTOM1SR1_ISR;
